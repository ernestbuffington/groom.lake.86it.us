...
class __TwigTemplate_385e6e2d72fb68d30ff302470edd43c15c798c5d108bea4611411eedcbe67f06 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        ...
        if (($context["U_EDIT_SELF"] ?? null)) {
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("EDIT_PROFILE");
            echo "</a> ]";
        }
        // line 26
        echo "\t\t\t";
        if (($context["U_USER_ADMIN"] ?? null)) {
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("USER_ADMIN");
            echo "</a> ]";
        }
        // line 27
        echo "\t\t\t";
        if (($context["U_USER_BAN"] ?? null)) {
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("USER_BAN");
            echo "</a> ]";
        }
        // line 28
        echo "\t\t\t";
        if (($context["U_SWITCH_PERMISSIONS"] ?? null)) {
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("USE_PERMISSIONS");
            echo "</a> ]";
        }
        // line 29
        echo "\t\t</dd>
\t\t";
        ...
        if ( !($context["AVATAR_IMG"] ?? null)) {
            ...
            if (($context["RANK_TITLE"] ?? null)) {
                echo "<dt>";
                echo $this->extensions['an602\template\twig\extension']->lang("RANK");
                echo $this->extensions['an602\template\twig\extension']->lang("COLON");
                echo "</dt> <dd>";
                echo ($context["RANK_TITLE"] ?? null);
                echo "</dd>";
        ...
        if (($context["S_USER_INACTIVE"] ?? null)) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("USER_IS_INACTIVE");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd>";
        ...
        if ((($context["AGE"] ?? null) !== "")) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("AGE");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd>";
        ...
        if (($context["S_GROUP_OPTIONS"] ?? null)) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("USERGROUPS");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd><select name=\"g\">";
            echo ($context["S_GROUP_OPTIONS"] ?? null);
            echo "</select> <input type=\"submit\" name=\"submit\" value=\"";
            echo $this->extensions['an602\template\twig\extension']->lang("GO");
...
\t\t\t";
        ...
        if ((($context["S_USER_LOGGED_IN"] ?? null) && ($context["S_ZEBRA"] ?? null))) {
            ...
            if (($context["U_REMOVE_FRIEND"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("REMOVE_FRIEND");
                echo "</strong></a></dd>
\t\t\t";
            } elseif (            // line 50
($context["U_REMOVE_FOE"] ?? null)) {
                ...
                echo "\" data-ajax=\"zebra\"><strong>";
                echo $this->extensions['an602\template\twig\extension']->lang("REMOVE_FOE");
                echo "</strong></a></dd>
\t\t\t";
            } else {
                // line 53
                ...
                if (($context["U_ADD_FRIEND"] ?? null)) {
                    ...
                    echo "\" data-ajax=\"zebra\"><strong>";
                    echo $this->extensions['an602\template\twig\extension']->lang("ADD_FRIEND");
                    echo "</strong></a></dd>
\t\t\t\t";
                }
                // line 56
                ...
                if (($context["U_ADD_FOE"] ?? null)) {
                    ...
                    echo "\" data-ajax=\"zebra\"><strong>";
                    echo $this->extensions['an602\template\twig\extension']->lang("ADD_FOE");
                    echo "</strong></a></dd>
\t\t\t\t";
                }
                // line 59
...
\t\t<h3>";
        // line 72
        echo $this->extensions['an602\template\twig\extension']->lang("CONTACT_USER");
        echo "</h3>
...
\t\t";
        ...
        if (($context["U_EMAIL"] ?? null)) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("EMAIL_ADDRESS");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd><a href=\"";
            echo ($context["U_EMAIL"] ?? null);
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("SEND_EMAIL_USER");
            echo "</a></dd>";
        }
        // line 76
        echo "\t\t";
        if (($context["U_PM"] ?? null)) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("PM");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd><a href=\"";
            echo ($context["U_PM"] ?? null);
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("SEND_PRIVATE_MESSAGE");
            echo "</a></dd>";
        }
        // line 77
        echo "\t\t";
        if ((($context["U_JABBER"] ?? null) && ($context["S_JABBER_ENABLED"] ?? null))) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("JABBER");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd><a href=\"";
            echo ($context["U_JABBER"] ?? null);
            echo "\" onclick=\"popup(this.href, 750, 320); return false;\">";
            echo $this->extensions['an602\template\twig\extension']->lang("SEND_JABBER_MESSAGE");
            echo "</a></dd>";
...
\t\t<h3>";
        // line 98
        echo $this->extensions['an602\template\twig\extension']->lang("USER_FORUM");
        echo "</h3>
\t\t<dl class=\"details\">
\t\t\t";
        // line 100
...
\t\t\t<dt>";
        // line 102
        echo $this->extensions['an602\template\twig\extension']->lang("LAST_ACTIVE");
        echo $this->extensions['an602\template\twig\extension']->lang("COLON");
        echo "</dt> <dd>";
...
\t\t\t";
        ...
        if (($context["S_WARNINGS"] ?? null)) {
            // line 104
            echo "\t\t\t<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("WARNINGS");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo " </dt>
\t\t\t<dd><strong>";
            // line 105
            ...
            if ((($context["U_NOTES"] ?? null) || ($context["U_WARN"] ?? null))) {
                ...
                if (($context["U_NOTES"] ?? null)) {
                    ...
                    echo "\">";
                    echo $this->extensions['an602\template\twig\extension']->lang("VIEW_NOTES");
                    echo "</a>";
                }
                echo " ";
                if (($context["U_WARN"] ?? null)) {
                    ...
                    echo "\">";
                    echo $this->extensions['an602\template\twig\extension']->lang("WARN_USER");
                    echo "</a>";
                }
                echo " ]";
            }
...
\t\t\t";
        ...
        // line 107
        echo "\t\t\t<dt>";
        echo $this->extensions['an602\template\twig\extension']->lang("TOTAL_POSTS");
        echo $this->extensions['an602\template\twig\extension']->lang("COLON");
        echo "</dt>
\t\t\t\t<dd>";
        // line 108
        ...
        if ((($context["POSTS_IN_QUEUE"] ?? null) && ($context["U_MCP_QUEUE"] ?? null))) {
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("POSTS_IN_QUEUE");
            echo "</a>)";
...
\t\t\t";
        ...
        if ((($context["S_SHOW_ACTIVITY"] ?? null) && ($context["POSTS"] ?? null))) {
            // line 113
            echo "\t\t\t\t<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("ACTIVE_IN_FORUM");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd>";
...
\t\t\t\t<dt>";
            // line 114
            echo $this->extensions['an602\template\twig\extension']->lang("ACTIVE_IN_TOPIC");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</dt> <dd>";
...
\t\t<h3>";
            // line 128
            echo $this->extensions['an602\template\twig\extension']->lang("SIGNATURE");
            echo "</h3>
