...
class __TwigTemplate_480362ba29dd596bb9fd6d2e630c8cc3dd3018b145a514d852680bfc58aaa8eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
            ...
            if (($context["U_MANAGE"] ?? null)) {
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("MANAGE_GROUP");
                echo "</a></p>
\t\t";
            }
            // line 24
...
\t\t\t";
            ...
            if (($context["GROUP_RANK"] ?? null)) {
                ...
                if ( !($context["RANK_IMG"] ?? null)) {
                    // line 34
                    echo "\t\t\t\t\t";
                    echo ($this->extensions['an602\template\twig\extension']->lang("GROUP_RANK") . $this->extensions['an602\template\twig\extension']->lang("COLON"));
                    echo "
\t\t\t\t";
                }
                // line 36
...
\t\t\t\t";
            ...
            if ((($context["U_FIND_MEMBER"] ?? null) &&  !($context["S_SEARCH_USER"] ?? null))) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("HIDE_MEMBER_SEARCH");
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("FIND_USERNAME");
                echo "</a> &bull; ";
...
\t\t\t<th class=\"name\" data-dfn=\"";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("COMMA_SEPARATOR");
            if ((($context["S_SHOW_GROUP"] ?? null) && twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "memberrow", [], "any", false, false, false, 72)))) {
                echo $this->extensions['an602\template\twig\extension']->lang("GROUP_LEADER");
            } else {
...
\t";
                    ...
                    if ( !($context["S_LEADERS_SET"] ?? null)) {
                        ...
                        echo "\">";
                        if (($context["S_SHOW_GROUP"] ?? null)) {
                            echo $this->extensions['an602\template\twig\extension']->lang("GROUP_MEMBERS");
                        } else {
                            echo $this->extensions['an602\template\twig\extension']->lang("USERNAME");
                        }
                        echo "</a></th>
...
\t\t<td><span class=\"rank-img\">";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["memberrow"], "S_INACTIVE", [], "any", false, false, false, 126)) {
                echo " (";
                echo $this->extensions['an602\template\twig\extension']->lang("INACTIVE");
                echo ")";
            }
            if (($context["S_IN_SEARCH_POPUP"] ?? null)) {
                ...
                echo "'); return false;\">";
                echo $this->extensions['an602\template\twig\extension']->lang("SELECT");
                echo "</a>&nbsp;]";
            }
            echo "</td>
\t\t<td class=\"posts\">";
...
\t\t<td colspan=\"";
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("NO_MEMBERS");
            echo "</td>
\t</tr>
\t\t";
        }
...
\t<input type=\"submit\" name=\"submit\" value=\"";
            // line 152
            echo $this->extensions['an602\template\twig\extension']->lang("SELECT_MARKED");
            echo "\" class=\"button2\" />
...
\t<label for=\"sk\">";
            // line 164
            echo $this->extensions['an602\template\twig\extension']->lang("SELECT_SORT_METHOD");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
...
\t<label for=\"sd\">";
            // line 165
            echo $this->extensions['an602\template\twig\extension']->lang("ORDER");
