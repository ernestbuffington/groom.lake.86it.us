...
class __TwigTemplate_937988d5a9021aac66612aee061f66c84a4dea35379bcde53ca704263e035c37 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<p>";
        // line 7
        echo $this->extensions['an602\template\twig\extension']->lang("FIND_USERNAME_EXPLAIN");
        echo "</p>
...
\t\t\t";
        ...
        echo "\" class=\"inputbox\"";
        if (($context["U_LIVE_SEARCH"] ?? null)) {
            echo " autocomplete=\"off\" data-filter=\"an602.search.filter\" data-ajax=\"member_search\" data-min-length=\"3\" data-url=\"";
...
\t\t<dt><label for=\"email\">";
            // line 29
            echo $this->extensions['an602\template\twig\extension']->lang("EMAIL");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label></dt>
...
\t\t<dt><label for=\"search_group_id\">";
        // line 40
        echo $this->extensions['an602\template\twig\extension']->lang("GROUP");
        echo $this->extensions['an602\template\twig\extension']->lang("COLON");
        echo "</label></dt>
...
\t\t<dt><label for=\"ip\">";
            // line 67
            echo $this->extensions['an602\template\twig\extension']->lang("POST_IP");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label></dt>
