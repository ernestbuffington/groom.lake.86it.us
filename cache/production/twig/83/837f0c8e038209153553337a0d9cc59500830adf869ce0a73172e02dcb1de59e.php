...
class __TwigTemplate_57eb0c158470dc81dec1d27d963857313021c4c33501e78d8efc7da629ab3202 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        if (((($context["U_POST_REPLY_PM"] ?? null) || ($context["U_POST_NEW_TOPIC"] ?? null)) || ($context["U_FORWARD_PM"] ?? null))) {
            ...
            if (($context["U_POST_REPLY_PM"] ?? null)) {
                // line 12
                echo "\t\t\t<a title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("POST_REPLY_PM");
                echo "\" href=\"";
                echo ($context["U_POST_REPLY_PM"] ?? null);
                echo "\" class=\"button\">
\t\t\t\t<span>";
                // line 13
                echo $this->extensions['an602\template\twig\extension']->lang("BUTTON_PM_REPLY");
...
($context["U_POST_NEW_TOPIC"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("UCP_PM_COMPOSE");
                echo "\" class=\"button\">
\t\t\t\t<span>";
                // line 17
                echo $this->extensions['an602\template\twig\extension']->lang("BUTTON_PM_NEW");
...
\t\t";
            ...
            if (($context["U_FORWARD_PM"] ?? null)) {
                // line 21
                echo "\t\t\t<a title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("POST_FORWARD_PM");
                echo "\" href=\"";
                echo ($context["U_FORWARD_PM"] ?? null);
                echo "\" class=\"button\">
\t\t\t\t<span>";
                // line 22
                echo $this->extensions['an602\template\twig\extension']->lang("BUTTON_PM_FORWARD");
...
\t\t";
            ...
            if ((($context["U_POST_REPLY_PM"] ?? null) && (($context["S_PM_RECIPIENTS"] ?? null) > 1))) {
                // line 26
                echo "\t\t\t<a title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("REPLY_TO_ALL");
                echo "\" href=\"";
                echo ($context["U_POST_REPLY_ALL"] ?? null);
                echo "\" class=\"button\">
\t\t\t\t<span>";
                // line 27
                echo $this->extensions['an602\template\twig\extension']->lang("BUTTON_PM_REPLY_ALL");
                echo "</span> <i class=\"icon fa-pencil fa-fw\" aria-hidden=\"true\"></i>
\t\t\t</a>
\t\t";
            }
...
\t\t\t<span title=\"";
            // line 34
            echo $this->extensions['an602\template\twig\extension']->lang("PM_TOOLS");
...
\t\t\t\t\t\t\t<a href=\"";
                ...
                echo "\" title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("PRINT_PM");
                echo "\" accesskey=\"p\">
...
\t\t\t\t\t<i class=\"icon fa-angle-";
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("RETURN_TO_FOLDER");
                echo "</span>
\t\t\t\t</a>
\t\t\t";
            } elseif ((            // line 59
($context["FOLDER_CUR_MESSAGES"] ?? null) != 0)) {
                ...
                if (($context["U_MARK_ALL"] ?? null)) {
                    ...
                    echo "\" class=\"mark\">";
                    echo $this->extensions['an602\template\twig\extension']->lang("PM_MARK_ALL_READ");
                    echo "</a> &bull; ";
                }
                // line 61
                echo "\t\t\t\t";
