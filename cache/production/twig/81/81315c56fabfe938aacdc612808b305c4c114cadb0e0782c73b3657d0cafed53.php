...
class __TwigTemplate_1ea7f21fb8824d18bdcf718d47e1734b7e24fa4d6d2a15d10f98214b946a394d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<span title=\"";
        // line 2
        echo $this->extensions['an602\template\twig\extension']->lang("SORT_OPTIONS");
...
\t\t\t\t<label>";
            // line 12
            echo $this->extensions['an602\template\twig\extension']->lang("SORT_DIRECTION");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
...
\t\t\t\t<input type=\"submit\" class=\"button2\" name=\"sort\" value=\"";
            // line 14
            echo $this->extensions['an602\template\twig\extension']->lang("SORT");
            echo "\" />
\t\t\t";
        } else {
            // line 16
            echo "\t\t\t\t<label>";
            echo $this->extensions['an602\template\twig\extension']->lang("DISPLAY");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo " ";
