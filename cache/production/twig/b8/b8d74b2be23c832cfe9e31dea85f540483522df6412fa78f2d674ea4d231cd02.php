...
/* index_body.html */
class __TwigTemplate_077f1197f57a804743095974d98aa96cc66a53c93c52b1277aadedfbf1a84ffb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<a href=\"";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("MARK_FORUMS_READ");
            echo "</a>
\t</div>
";
        }
...
\t\t\t";
            ...
            if (($context["U_SEND_PASSWORD"] ?? null)) {
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("FORGOT_PASS");
                echo "</a>
\t\t\t";
            }
            // line 27
...
\t\t\t";
            ...
            echo " (";
            echo $this->extensions['an602\template\twig\extension']->lang("ONLINE_EXPLAIN");
            echo ")<br />";
...
\t\t\t\t";
                ...
                if (($context["LEGEND"] ?? null)) {
                    echo "<br /><em>";
                    echo $this->extensions['an602\template\twig\extension']->lang("LEGEND");
                    echo $this->extensions['an602\template\twig\extension']->lang("COLON");
                    echo " ";
...
\t\t<h3>";
            // line 58
            echo $this->extensions['an602\template\twig\extension']->lang("BIRTHDAYS");
            echo "</h3>
\t\t<p>
\t\t\t";
            // line 60
            ...
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "birthdays", [], "any", false, false, false, 61))) {
                echo $this->extensions['an602\template\twig\extension']->lang("CONGRATULATIONS");
                echo $this->extensions['an602\template\twig\extension']->lang("COLON");
                echo " <strong>";
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("NO_BIRTHDAYS");
            }
            // line 62
            echo "\t\t\t";
            // line 63
...
\t\t<h3>";
            // line 69
            echo $this->extensions['an602\template\twig\extension']->lang("STATISTICS");
            echo "</h3>
\t\t<p>
\t\t\t";
            // line 71
