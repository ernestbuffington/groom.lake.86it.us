...
class __TwigTemplate_f2fb5327b24bbdf7a2467c2a747b96192de39e89fe6bcd2109d3f5d99392e2b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t{
\t\tan602.toggleDisplay('colour_palette');
...
\t\t\tdocument.getElementById('bbpalette').value = '";
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['an602\template\twig\extension']->lang("FONT_COLOR_HIDE"), "js");
        echo "';
\t\t}
\t\telse
\t\t{
\t\t\tdocument.getElementById('bbpalette').value = '";
        // line 24
        echo twig_escape_filter($this->env, $this->extensions['an602\template\twig\extension']->lang("FONT_COLOR"), "js");
        echo "';
\t\t}
\t}
</script>
...
\t\t<dt><label>";
            // line 33
            echo $this->extensions['an602\template\twig\extension']->lang("FONT_COLOR");
...
\t<button type=\"button\" class=\"button button-icon-only bbcode-b\" accesskey=\"b\" name=\"addbbcode0\" value=\" B \" onclick=\"bbstyle(0)\" title=\"";
            // line 40
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_B_HELP");
            echo "\">
...
\t<button type=\"button\" class=\"button button-icon-only bbcode-i\" accesskey=\"i\" name=\"addbbcode2\" value=\" i \" onclick=\"bbstyle(2)\" title=\"";
            // line 43
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_I_HELP");
            echo "\">
...
\t<button type=\"button\" class=\"button button-icon-only bbcode-u\" accesskey=\"u\" name=\"addbbcode4\" value=\" u \" onclick=\"bbstyle(4)\" title=\"";
            // line 46
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_U_HELP");
            echo "\">
...
\t";
            ...
            if (($context["S_BBCODE_QUOTE"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_Q_HELP");
                echo "\">
...
\t";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_C_HELP");
            echo "\">
...
\t<button type=\"button\" class=\"button button-icon-only bbcode-list\" accesskey=\"l\" name=\"addbbcode10\" value=\"List\" onclick=\"bbstyle(10)\" title=\"";
            // line 57
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_L_HELP");
            echo "\">
...
\t<button type=\"button\" class=\"button button-icon-only bbcode-list-\" accesskey=\"o\" name=\"addbbcode12\" value=\"List=\" onclick=\"bbstyle(12)\" title=\"";
            // line 60
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_O_HELP");
            echo "\">
...
\t<button type=\"button\" class=\"button button-icon-only bbcode-asterisk\" accesskey=\"y\" name=\"addlistitem\" value=\"[*]\" onclick=\"bbstyle(-1)\" title=\"";
            // line 63
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_LISTITEM_HELP");
            echo "\">
...
\t";
            ...
            if (($context["S_BBCODE_IMG"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_P_HELP");
                echo "\">
...
\t";
            ...
            if (($context["S_LINKS_ALLOWED"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_W_HELP");
                echo "\">
...
\t";
            ...
            if (($context["S_BBCODE_FLASH"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_D_HELP");
                echo "\">
...
\t";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_S_HELP");
            echo "\">
...
\t<select name=\"addbbcode20\" class=\"bbcode-size\" onchange=\"bbfontstyle('[size=' + this.form.addbbcode20.options[this.form.addbbcode20.selectedIndex].value + ']', '[/size]');this.form.addbbcode20.selectedIndex = 2;\" title=\"";
            // line 84
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_F_HELP");
            echo "\">
\t\t<option value=\"50\">";
            // line 85
            echo $this->extensions['an602\template\twig\extension']->lang("FONT_TINY");
            echo "</option>
\t\t<option value=\"85\">";
            // line 86
            echo $this->extensions['an602\template\twig\extension']->lang("FONT_SMALL");
            echo "</option>
\t\t<option value=\"100\" selected=\"selected\">";
            // line 87
            echo $this->extensions['an602\template\twig\extension']->lang("FONT_NORMAL");
            echo "</option>
\t\t";
            // line 88
            if (( !($context["MAX_FONT_SIZE"] ?? null) || (($context["MAX_FONT_SIZE"] ?? null) >= 150))) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FONT_LARGE");
                echo "</option>
\t\t\t";
                // line 90
                if (( !($context["MAX_FONT_SIZE"] ?? null) || (($context["MAX_FONT_SIZE"] ?? null) >= 200))) {
                    ...
                    echo $this->extensions['an602\template\twig\extension']->lang("FONT_HUGE");
                    echo "</option>
\t\t\t";
                }
                // line 93
