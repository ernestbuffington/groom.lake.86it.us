...
/* search_results.html */
class __TwigTemplate_83d56724b12a4ed1a024081fc351d71d48cdd411d311823ef73145a8444f7fe0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["SEARCHED_QUERY"] ?? null)) {
            echo " <p>";
            echo $this->extensions['an602\template\twig\extension']->lang("SEARCHED_QUERY");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo " <strong>";
        ...
        if (($context["IGNORED_WORDS"] ?? null)) {
            echo " <p>";
            echo $this->extensions['an602\template\twig\extension']->lang("IGNORED_TERMS");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo " <strong>";
        ...
        if (($context["PHRASE_SEARCH_DISABLED"] ?? null)) {
            echo " <p><strong>";
            echo $this->extensions['an602\template\twig\extension']->lang("PHRASE_SEARCH_DISABLED");
            echo "</strong></p>";
        }
        // line 9
        echo "
...
\t\t\t<i class=\"icon fa-angle-";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("RETURN_TO_TOPIC");
            echo "</span>
\t\t</a>
\t</p>
";
...
\t\t\t<i class=\"icon fa-angle-";
            ...
            echo ($context["S_CONTENT_FLOW_BEGIN"] ?? null);
            echo " fa-fw icon-black\" aria-hidden=\"true\"></i><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("GO_TO_SEARCH_ADV");
            echo "</span>
\t\t</a>
\t</p>
";
...
\t\t\t\t<input class=\"inputbox search tiny\" type=\"search\" name=\"add_keywords\" id=\"add_keywords\" value=\"\" placeholder=\"";
                // line 33
                echo $this->extensions['an602\template\twig\extension']->lang("SEARCH_IN_RESULTS");
                echo "\" />
...
\t\t\t";
            ...
            if (($context["U_MARK_ALL_READ"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("MARK_ALL_READ");
                echo "</a> &bull;";
            }
            // line 49
            echo "\t\t\t";
...
\t\t\t\t\t\t\t\t\t<i class=\"icon fa-file fa-fw icon-red icon-md\" aria-hidden=\"true\"></i><span class=\"sr-only\">";
                        // line 88
                        echo $this->extensions['an602\template\twig\extension']->lang("NEW_POST");
                        echo "</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t";
                    }
...
\t\t\t<strong>";
                // line 169
                echo $this->extensions['an602\template\twig\extension']->lang("NO_SEARCH_RESULTS");
                echo "</strong>
\t\t\t</div>
\t\t</div>
\t";
...
\t\t\t\t\t<i class=\"icon fa-angle-";
                    ...
                    echo ($context["S_CONTENT_FLOW_END"] ?? null);
                    echo " fa-fw icon-black\" aria-hidden=\"true\"></i><span>";
                    echo $this->extensions['an602\template\twig\extension']->lang("JUMP_TO_POST");
                    echo "</span>
\t\t\t\t</a>
\t\t\t</li>
\t\t</ul>
