...
class __TwigTemplate_effdbb13e5bf57e10dc4c5709a9f30cc83814e1fbbe1144c12b82050dcc3adf9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
            // line 17
            echo $this->extensions['an602\template\twig\extension']->lang("NO_NOTIFICATIONS");
            echo "
\t\t\t\t</li>
\t\t\t";
        }
...
\t\t\t\t\t";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["notifications"], "UNREAD", [], "any", false, false, false, 34)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("MARK_READ");
                echo "\">
...
\t\t\t<a href=\"";
        ...
        echo "\"><span>";
        echo $this->extensions['an602\template\twig\extension']->lang("SEE_ALL");
        echo "</span></a>
\t\t</div>
\t</div>
</div>
