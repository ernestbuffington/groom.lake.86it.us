...
/* forumlist_body.html */
class __TwigTemplate_5b60d257e10c8987024805096a62c1095fb9c4ad9ae442d5d2a141e854e54ca7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["subforum"]) {
                        ...
                        echo "\" title=\"";
                        if (twig_get_attribute($this->env, $this->source, $context["subforum"], "S_UNREAD", [], "any", false, false, false, 59)) {
                            echo $this->extensions['an602\template\twig\extension']->lang("UNREAD_POSTS");
                        } else {
                            echo $this->extensions['an602\template\twig\extension']->lang("NO_UNREAD_POSTS");
                        }
                        echo "\">
\t\t\t\t\t\t\t\t\t<i class=\"icon ";
                        // line 60
...
\t\t\t\t\t\t\t";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["forumrow"], "CLICKS", [], "any", false, false, false, 67)) {
                        // line 68
                        echo "\t\t\t\t\t\t\t\t";
                        echo $this->extensions['an602\template\twig\extension']->lang("REDIRECTS");
                        echo $this->extensions['an602\template\twig\extension']->lang("COLON");
                        echo " <strong>";
...
\t\t\t\t\t\t\t";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["forumrow"], "U_UNAPPROVED_TOPICS", [], "any", false, false, false, 83)) {
                        ...
                        echo "\" title=\"";
                        echo $this->extensions['an602\template\twig\extension']->lang("TOPICS_UNAPPROVED");
                        echo "\">
...
$context["forumrow"], "U_UNAPPROVED_POSTS", [], "any", false, false, false, 87)) {
                        ...
                        echo "\" title=\"";
                        echo $this->extensions['an602\template\twig\extension']->lang("POSTS_UNAPPROVED_FORUM");
                        echo "\">
\t\t\t\t\t\t\t\t\t<i class=\"icon fa-question fa-fw icon-blue\" aria-hidden=\"true\"></i><span class=\"sr-only\">";
                        // line 89
                        echo $this->extensions['an602\template\twig\extension']->lang("POSTS_UNAPPROVED_FORUM");
...
\t\t\t\t\t\t\t\t";
                        ...
                        if ( !($context["S_IS_BOT"] ?? null)) {
                            ...
                            echo "\" title=\"";
                            echo $this->extensions['an602\template\twig\extension']->lang("VIEW_LATEST_POST");
                            echo "\">
...
\t\t\t\t\t\t\t";
                        ...
                        if (twig_get_attribute($this->env, $this->source, $context["forumrow"], "U_UNAPPROVED_TOPICS", [], "any", false, false, false, 106)) {
                            // line 107
                            echo "\t\t\t\t\t\t\t\t";
                            echo $this->extensions['an602\template\twig\extension']->lang("TOPIC_UNAPPROVED_FORUM", twig_get_attribute($this->env, $this->source, $context["forumrow"], "TOPICS", [], "any", false, false, false, 107));
                            echo "
\t\t\t\t\t\t\t";
                        } else {
                            // line 109
                            echo "\t\t\t\t\t\t\t\t";
                            echo $this->extensions['an602\template\twig\extension']->lang("NO_POSTS");
                            echo "
\t\t\t\t\t\t\t";
                        }
                        // line 111
...
\t\t<strong>";
            // line 134
            echo $this->extensions['an602\template\twig\extension']->lang("NO_FORUMS");
            echo "</strong>
\t\t</div>
\t</div>
";
