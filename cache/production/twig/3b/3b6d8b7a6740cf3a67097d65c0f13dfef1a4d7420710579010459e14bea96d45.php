...
/* acp_bots.html */
class __TwigTemplate_04ba78cb18a2be766cb117de129b50176a8fb38f63909b986f7bcada3d920f61 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<a href=\"";
            ...
            echo ";\">&laquo; ";
            echo $this->extensions['an602\template\twig\extension']->lang("BACK");
            echo "</a>

\t<h1>";
            // line 9
            echo $this->extensions['an602\template\twig\extension']->lang("TITLE");
            echo "</h1>

\t<p>";
            // line 11
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_EDIT_EXPLAIN");
            echo "</p>
...
\t\t<dt><label for=\"bot_name\">";
            // line 25
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_NAME");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_NAME_EXPLAIN");
            echo "</span></dt>
...
\t\t<dt><label for=\"bot_style\">";
            // line 29
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_STYLE");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_STYLE_EXPLAIN");
            echo "</span></dt>
...
\t\t<dt><label for=\"bot_lang\">";
            // line 33
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_LANG");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_LANG_EXPLAIN");
            echo "</span></dt>
...
\t\t<dt><label for=\"bot_active\">";
            // line 37
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_ACTIVE");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label></dt>
...
\t\t<dt><label for=\"bot_agent\">";
            // line 41
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_AGENT");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_AGENT_EXPLAIN");
            echo "</span></dt>
...
\t\t<dt><label for=\"bot_ip\">";
            // line 45
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_IP");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_IP_EXPLAIN");
            echo "</span></dt>
...
\t\t<input class=\"button1\" type=\"submit\" id=\"submit\" name=\"submit\" value=\"";
            // line 50
            echo $this->extensions['an602\template\twig\extension']->lang("SUBMIT");
            echo "\" />&nbsp;
\t\t<input class=\"button2\" type=\"reset\" id=\"reset\" name=\"reset\" value=\"";
            // line 51
            echo $this->extensions['an602\template\twig\extension']->lang("RESET");
            echo "\" />
\t\t";
            // line 52
...
\t<h1>";
            // line 59
            echo $this->extensions['an602\template\twig\extension']->lang("BOTS");
            echo "</h1>

\t<p>";
            // line 61
            echo $this->extensions['an602\template\twig\extension']->lang("BOTS_EXPLAIN");
            echo "</p>
...
\t\t<th>";
            // line 69
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_LAST_VISIT");
            echo "</th>
\t\t<th colspan=\"3\">";
            // line 70
            echo $this->extensions['an602\template\twig\extension']->lang("OPTIONS");
            echo "</th>
\t\t<th>";
            // line 71
            echo $this->extensions['an602\template\twig\extension']->lang("MARK");
            echo "</th>
\t</tr>
\t</thead>
\t<tbody>
...
\t\t\t<td style=\"text-align: center;\">&nbsp;<a href=\"";
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("EDIT");
                echo "</a>&nbsp;</td>
\t\t\t<td style=\"text-align: center;\">&nbsp;<a href=\"";
                // line 81
                echo twig_get_attribute($this->env, $this->source, $context["bots"], "U_DELETE", [], "any", false, false, false, 81);
                echo "\" data-ajax=\"row_delete\">";
                echo $this->extensions['an602\template\twig\extension']->lang("DELETE");
                echo "</a>&nbsp;</td>
...
\t\t<input class=\"button2\" name=\"add\" type=\"submit\" value=\"";
            // line 89
            echo $this->extensions['an602\template\twig\extension']->lang("BOT_ADD");
            echo "\" />
\t</fieldset>
...
\t\t<p class=\"small\"><a href=\"#\" onclick=\"marklist('acp_bots', 'mark', true);\">";
            // line 95
            echo $this->extensions['an602\template\twig\extension']->lang("MARK_ALL");
            echo "</a> &bull; <a href=\"#\" onclick=\"marklist('acp_bots', 'mark', false);\">";
            echo $this->extensions['an602\template\twig\extension']->lang("UNMARK_ALL");
            echo "</a></p>
\t\t";
            // line 96
            echo ($context["S_FORM_TOKEN"] ?? null);
