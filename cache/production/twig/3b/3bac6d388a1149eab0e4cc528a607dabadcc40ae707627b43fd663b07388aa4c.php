...
class __TwigTemplate_0cbc1af17ba3700d045c423ebaf4961bce7a4d5ba3c403002185feb36cc06610 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<p>";
        // line 4
        echo $this->extensions['an602\template\twig\extension']->lang("ADD_ATTACHMENT_EXPLAIN");
        echo " <span class=\"hidden\" id=\"drag-n-drop-message\">";
        echo $this->extensions['an602\template\twig\extension']->lang("PLUPLOAD_DRAG_TEXTAREA");
        echo "</span></p>
\t";
        // line 5
...
\t\t<dt><label for=\"fileupload\">";
        // line 9
        echo $this->extensions['an602\template\twig\extension']->lang("FILENAME");
...
\t\t\t<input type=\"submit\" name=\"add_file\" value=\"";
        // line 12
        echo $this->extensions['an602\template\twig\extension']->lang("ADD_FILE");
...
\t\t<dt><label for=\"filecomment\">";
        // line 16
        echo $this->extensions['an602\template\twig\extension']->lang("FILE_COMMENT");
        echo $this->extensions['an602\template\twig\extension']->lang("COLON");
        echo "</label></dt>
...
\t\t<input type=\"button\" class=\"button2\" value=\"";
        // line 22
        echo $this->extensions['an602\template\twig\extension']->lang("PLUPLOAD_ADD_FILES");
        echo "\" id=\"add_files\" />
\t</div>
...
\t\t\t\t\t\t<th class=\"attach-name\">";
        // line 31
        echo $this->extensions['an602\template\twig\extension']->lang("PLUPLOAD_FILENAME");
        echo "</th>
...
\t\t\t\t\t\t<th class=\"attach-filesize\">";
        // line 33
        echo $this->extensions['an602\template\twig\extension']->lang("PLUPLOAD_SIZE");
        echo "</th>
\t\t\t\t\t\t<th class=\"attach-status\">";
        // line 34
        echo $this->extensions['an602\template\twig\extension']->lang("PLUPLOAD_STATUS");
        echo "</th>
\t\t\t\t\t</tr>
\t\t\t\t</thead>
...
\t\t\t\t\t\t\t\t\t";
        ...
        if (($context["S_BBCODE_ALLOWED"] ?? null)) {
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("PLACE_INLINE");
            echo "\" class=\"button2 hidden file-inline-bbcode\" />&nbsp;";
        }
        // line 43
        echo "\t\t\t\t\t\t\t\t\t<input type=\"button\" value=\"";
        echo $this->extensions['an602\template\twig\extension']->lang("DELETE_FILE");
