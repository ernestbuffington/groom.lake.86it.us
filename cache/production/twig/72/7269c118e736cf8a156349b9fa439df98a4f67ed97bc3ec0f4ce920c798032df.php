...
/* ucp_header.html */
class __TwigTemplate_1f7d75a3f138d44616633d99433d3e63163a7be093f82d635a985a183a5b5b7c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<dt>";
            // line 69
            echo $this->extensions['an602\template\twig\extension']->lang("FRIENDS");
            echo "</dt>
...
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["friends_online"]) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FRIENDS_ONLINE");
                echo "\">";
                ...
                if (($context["S_SHOW_PM_BOX"] ?? null)) {
                    ...
                    echo "]\" value=\"";
                    echo $this->extensions['an602\template\twig\extension']->lang("ADD");
                    echo "\" class=\"button2\" />";
                }
...
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["friends_offline"]) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FRIENDS_OFFLINE");
                echo "\">";
...
\t\t\t\t<dt>";
            // line 89
            echo $this->extensions['an602\template\twig\extension']->lang("MESSAGE_COLOURS");
            echo "</dt>
\t\t\t\t";
            // line 90
            $context['_parent'] = $context;
