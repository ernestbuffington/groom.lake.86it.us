...
/* ucp_main_front.html */
class __TwigTemplate_0b442403f809e32d48347a6a31230fcdb3b5c28f718e77ecf3982a682c56d9e1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<p>";
        // line 8
        echo $this->extensions['an602\template\twig\extension']->lang("UCP_WELCOME");
        echo "</p>
...
";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "topicrow", [], "any", false, false, false, 10))) {
            // line 11
            echo "\t<h3>";
            echo $this->extensions['an602\template\twig\extension']->lang("IMPORTANT_NEWS");
            echo "</h3>
...
\t<h3>";
        // line 64
        echo $this->extensions['an602\template\twig\extension']->lang("YOUR_DETAILS");
        echo "</h3>
...
\t\t<dt>";
        ...
        if (($context["POSTS_PCT"] ?? null)) {
            ...
            if (($context["S_DISPLAY_SEARCH"] ?? null)) {
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("SEARCH_YOUR_POSTS");
                echo "</a></strong>";
            }
            echo "<br />(";
...
\t\t";
        ...
        if (($context["WARNINGS"] ?? null)) {
            echo "<dt>";
            echo $this->extensions['an602\template\twig\extension']->lang("YOUR_WARNINGS");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
