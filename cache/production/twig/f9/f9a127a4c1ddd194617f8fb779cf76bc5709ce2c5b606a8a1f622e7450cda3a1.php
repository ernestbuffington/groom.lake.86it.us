...
/* jumpbox.html */
class __TwigTemplate_e4159ab7dc9cceb1589b5e0b7d203f40b2a2f4c55eb8a34446a2e01821928b4d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<i class=\"icon fa-angle-";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("RETURN_TO_FORUM");
            echo "</span>
\t\t</a>
\t</p>
\t";
...
\t\t\t<i class=\"icon fa-angle-";
            ...
            echo ($context["S_CONTENT_FLOW_BEGIN"] ?? null);
            echo " fa-fw icon-black\" aria-hidden=\"true\"></i><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("RETURN_TO_INDEX");
            echo "</span>
\t\t</a>
\t</p>
\t";
...
\t\t\t<span title=\"";
            ...
            if ((($context["S_IN_MCP"] ?? null) && ($context["S_MERGE_SELECT"] ?? null))) {
                echo $this->extensions['an602\template\twig\extension']->lang("SELECT_TOPICS_FROM");
            } elseif (($context["S_IN_MCP"] ?? null)) {
                echo $this->extensions['an602\template\twig\extension']->lang("MODERATE_FORUM");
            } else {
                echo $this->extensions['an602\template\twig\extension']->lang("JUMP_TO");
            }
