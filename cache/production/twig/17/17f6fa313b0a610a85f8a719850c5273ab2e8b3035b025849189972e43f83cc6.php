...
class __TwigTemplate_d00ba1833e0d80c62791b7d6c0952f00d23805d50994daa97907f5572badd218 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["PROMPT"] ?? null)) {
            // line 8
            echo "\t<h2>";
            echo $this->extensions['an602\template\twig\extension']->lang("EXPORT_AS_CSV");
            echo "</h2>
...
\t\t\t\t<dt><label for=\"delimiter\">";
            // line 15
            echo $this->extensions['an602\template\twig\extension']->lang("DELIMITER");
...
\t\t\t\t<dt><label for=\"enclosure\">";
            // line 19
            echo $this->extensions['an602\template\twig\extension']->lang("ENCLOSURE");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</label></dt>
...
\t\t<input class=\"button1\" type=\"submit\" name=\"submit_export\" value=\"";
            // line 27
            echo $this->extensions['an602\template\twig\extension']->lang("EXPORT_FOLDER");
            echo "\" />&nbsp;
...
\t\t\t\t\t<dt><div class=\"list-inner\">";
                // line 51
                echo $this->extensions['an602\template\twig\extension']->lang("MESSAGE");
                echo "</div></dt>
\t\t\t\t\t<dd class=\"mark\">";
                // line 52
...
\t\t\t\t\t\t";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["messagerow"], "S_PM_DELETED", [], "any", false, false, false, 65)) {
                        ...
                        echo $this->extensions['an602\template\twig\extension']->lang("DELETE_MESSAGE");
                        echo "</a><br />
\t\t\t\t\t\t\t<span class=\"error\">";
                        // line 67
                        echo $this->extensions['an602\template\twig\extension']->lang("MESSAGE_REMOVED_FROM_OUTBOX");
                        echo "</span>
\t\t\t\t\t\t";
                    } else {
                        // line 69
...
\t\t\t\t\t\t";
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["messagerow"], "S_AUTHOR_DELETED", [], "any", false, false, false, 71)) {
                        ...
                        echo $this->extensions['an602\template\twig\extension']->lang("PM_FROM_REMOVED_AUTHOR");
                        echo "</em>
\t\t\t\t\t\t";
                    }
                    // line 74
...
\t\t\t\t\t\t";
                    // line 79
                    if (($context["S_SHOW_RECIPIENTS"] ?? null)) {
                        echo $this->extensions['an602\template\twig\extension']->lang("MESSAGE_TO");
                        echo " ";
                        echo twig_get_attribute($this->env, $this->source, $context["messagerow"], "RECIPIENTS", [], "any", false, false, false, 79);
                    } else {
                        echo $this->extensions['an602\template\twig\extension']->lang("MESSAGE_BY_AUTHOR");
                        echo " ";
...
\t\t\t\t\t";
                    ...
                    if (($context["S_SHOW_RECIPIENTS"] ?? null)) {
                        ...
                        echo $this->extensions['an602\template\twig\extension']->lang("SENT_AT");
                        echo $this->extensions['an602\template\twig\extension']->lang("COLON");
                        echo " ";
                    ...
                    if (($context["S_UNREAD"] ?? null)) {
                        ...
                        if (twig_get_attribute($this->env, $this->source, $context["messagerow"], "FOLDER", [], "any", false, false, false, 84)) {
                            ...
                            echo $this->extensions['an602\template\twig\extension']->lang("UNKNOWN_FOLDER");
                        }
                        echo "</dd>";
                    }
                    // line 85
...
\t\t\t";
                ...
                if ((($context["S_COMPOSE_PM_VIEW"] ?? null) && ($context["S_NO_AUTH_SEND_MESSAGE"] ?? null))) {
                    ...
                    if (($context["S_USER_NEW"] ?? null)) {
                        echo $this->extensions['an602\template\twig\extension']->lang("USER_NEW_PERMISSION_DISALLOWED");
                    } else {
                        echo $this->extensions['an602\template\twig\extension']->lang("NO_AUTH_SEND_MESSAGE");
                    }
                    // line 95
                    echo "\t\t\t";
                } else {
                    // line 96
                    echo "\t\t\t\t";
                    echo $this->extensions['an602\template\twig\extension']->lang("NO_MESSAGES");
                    echo "
\t\t\t";
                }
                // line 98
...
\t\t\t<div class=\"left-box\"><label for=\"export_option\">";
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("EXPORT_AS_CSV_EXCEL");
                echo "</option><option value=\"XML\">";
                echo $this->extensions['an602\template\twig\extension']->lang("EXPORT_AS_XML");
