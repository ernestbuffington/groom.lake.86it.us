...
/* acp_help_an602.html */
class __TwigTemplate_0c2f4456398a9774ee21d02637415b57095830867bf27bb21a9455b27212a8b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->loadTemplate("overall_header.html", "acp_help_an602.html", 1)->display($context);
        if ($namespace) {
...
<h1>";
        // line 5
        echo $this->extensions['an602\template\twig\extension']->lang("ACP_HELP_PHPBB");
        echo "</h1>

<form id=\"acp_help_an602\" method=\"post\" action=\"";
        // line 7
...
\t";
        ...
        $this->env->loadTemplate('@an602_viglink/event/acp_help_an602_stats_before.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 10
        echo "\t<div class=\"send-stats-tile\">
\t\t<h2><i class=\"icon fa-bar-chart\"></i>";
        // line 11
        echo $this->extensions['an602\template\twig\extension']->lang("SEND_STATISTICS");
        echo "</h2>
\t\t<p>";
        // line 12
        echo $this->extensions['an602\template\twig\extension']->lang("EXPLAIN_SEND_STATISTICS");
        echo "</p>
\t\t<div class=\"send-stats-row\">
...
\t\t\t\t<a id=\"trigger-configlist\" data-ajax=\"toggle_link\" data-overlay=\"false\" data-toggle-text=\"";
        // line 15
        echo $this->extensions['an602\template\twig\extension']->lang("HIDE_STATISTICS");
        echo "\"><span>";
        echo $this->extensions['an602\template\twig\extension']->lang("SHOW_STATISTICS");
...
\t\t\t<dd>";
        // line 38
        echo $this->extensions['an602\template\twig\extension']->lang("SEND_STATISTICS_LONG");
        echo "</dd>
\t\t</dl>
\t</div>
\t<script>
...
\t";
        ...
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('an602_viglink', '__main__'));
        $this->env->loadTemplate('@an602_viglink/event/acp_help_an602_stats_after.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 45
        echo "\t<fieldset>
\t\t<legend>";
        // line 46
        echo $this->extensions['an602\template\twig\extension']->lang("ACP_SUBMIT_CHANGES");
        echo "</legend>
...
";
        ...
        $this->loadTemplate("overall_footer.html", "acp_help_an602.html", 69)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
    ...
    {
        return new Source("", "acp_help_an602.html", "");
    }
}
