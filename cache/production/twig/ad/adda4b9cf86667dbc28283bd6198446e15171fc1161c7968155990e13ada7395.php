...
/* viewforum_body.html */
class __TwigTemplate_f0f769aa85c26c25e2abd1f30b67077c8a1bd3b9ef864cba6164fc9b23a0d70f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            ...
            if (($context["MODERATORS"] ?? null)) {
                ...
                if (($context["S_SINGLE_MODERATOR"] ?? null)) {
                    echo $this->extensions['an602\template\twig\extension']->lang("MODERATOR");
                } else {
                    echo $this->extensions['an602\template\twig\extension']->lang("MODERATORS");
                }
...
\t\t";
            ...
            if (($context["U_FORUM_RULES"] ?? null)) {
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("FORUM_RULES");
                echo "</a>
\t\t";
            } else {
                // line 20
...
\t\t<a href=\"";
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("MARK_SUBFORUMS_READ");
                echo "</a>
\t</div>
";
            }
...
\t\t<a href=\"";
                ...
                if (($context["S_IS_LOCKED"] ?? null)) {
                    echo $this->extensions['an602\template\twig\extension']->lang("FORUM_LOCKED");
                } else {
                    echo $this->extensions['an602\template\twig\extension']->lang("POST_TOPIC");
                }
                echo "\">
\t\t\t";
                // line 44
                if (($context["S_IS_LOCKED"] ?? null)) {
                    // line 45
                    echo "\t\t\t\t<span>";
                    echo $this->extensions['an602\template\twig\extension']->lang("BUTTON_FORUM_LOCKED");
                    echo "</span> <i class=\"icon fa-lock fa-fw\" aria-hidden=\"true\"></i>
\t\t\t";
                } else {
                    // line 47
                    echo "\t\t\t\t<span>";
                    echo $this->extensions['an602\template\twig\extension']->lang("BUTTON_NEW_TOPIC");
...
\t\t\t\t<input class=\"inputbox search tiny\" type=\"search\" name=\"keywords\" id=\"search_keywords\" size=\"20\" placeholder=\"";
                // line 57
                echo $this->extensions['an602\template\twig\extension']->lang("SEARCH_FORUM");
                echo "\" />
...
\t\t\t\t<a href=\"";
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("SEARCH_ADV");
                echo "\">
...
\t\t";
            ...
            if ((( !($context["S_IS_BOT"] ?? null) && ($context["U_MARK_TOPICS"] ?? null)) && twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "topicrow", [], "any", false, false, false, 71)))) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("MARK_TOPICS_READ");
                echo "</a> &bull; ";
            }
            // line 72
            echo "\t\t";
...
\t\t<strong>";
            // line 87
            echo $this->extensions['an602\template\twig\extension']->lang("NO_READ_ACCESS");
            echo "</strong>
\t\t</div>
\t</div>
...
\t\t\t\t<h3><a href=\"";
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("LOGIN_LOGOUT");
                echo "</a>";
                if (($context["S_REGISTER_ENABLED"] ?? null)) {
                    echo "&nbsp; &bull; &nbsp;<a href=\"";
                    echo ($context["U_REGISTER"] ?? null);
                    echo "\">";
                    echo $this->extensions['an602\template\twig\extension']->lang("REGISTER");
                    echo "</a>";
                }
                echo "</h3>
...
\t\t\t\t\t<dt><label for=\"password\">";
                // line 107
                echo $this->extensions['an602\template\twig\extension']->lang("PASSWORD");
                echo $this->extensions['an602\template\twig\extension']->lang("COLON");
                echo "</label></dt>
...
\t\t\t\t\t";
                ...
                if (($context["S_AUTOLOGIN_ENABLED"] ?? null)) {
                    ...
                    echo $this->extensions['an602\template\twig\extension']->lang("LOG_ME_IN");
                    echo "</label></dd>";
                }
                // line 110
                echo "\t\t\t\t\t<dd><label for=\"viewonline\"><input type=\"checkbox\" name=\"viewonline\" id=\"viewonline\" tabindex=\"4\" /> ";
                echo $this->extensions['an602\template\twig\extension']->lang("HIDE_ME");
                echo "</label></dd>
\t\t\t\t</dl>
\t\t\t\t<dl>
\t\t\t\t\t<dt>&nbsp;</dt>
\t\t\t\t\t<dd><input type=\"submit\" name=\"login\" tabindex=\"5\" value=\"";
                // line 114
                echo $this->extensions['an602\template\twig\extension']->lang("LOGIN");
...
\t\t\t\t\t<dt";
                ...
                if (($context["S_DISPLAY_ACTIVE"] ?? null)) {
                    echo $this->extensions['an602\template\twig\extension']->lang("ACTIVE_TOPICS");
                    ...
                    echo $this->extensions['an602\template\twig\extension']->lang("ANNOUNCEMENTS");
                } else {
...
\t\t\t\t\t<dd class=\"posts\">";
                // line 147
                echo $this->extensions['an602\template\twig\extension']->lang("REPLIES");
                echo "</dd>
\t\t\t\t\t<dd class=\"views\">";
                // line 148
                echo $this->extensions['an602\template\twig\extension']->lang("VIEWS");
                echo "</dd>
\t\t\t\t\t<dd class=\"lastpost\"><span>";
                // line 149
                echo $this->extensions['an602\template\twig\extension']->lang("LAST_POST");
                echo "</span></dd>
\t\t\t\t</dl>
\t\t\t</li>
\t\t</ul>
...
\t\t\t\t\t\t";
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_TOPIC_UNAPPROVED", [], "any", false, false, false, 170) || twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_POSTS_UNAPPROVED", [], "any", false, false, false, 170))) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_TOPIC_UNAPPROVED", [], "any", false, false, false, 171)) {
                    echo $this->extensions['an602\template\twig\extension']->lang("TOPIC_UNAPPROVED");
                } else {
                    echo $this->extensions['an602\template\twig\extension']->lang("POSTS_UNAPPROVED");
                }
                echo "\">
...
\t\t\t\t\t\t";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_TOPIC_DELETED", [], "any", false, false, false, 175)) {
                ...
                echo "\" title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("TOPIC_DELETED");
                echo "\">
...
\t\t\t\t\t\t";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_TOPIC_REPORTED", [], "any", false, false, false, 180)) {
                ...
                echo "\" title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("TOPIC_REPORTED");
                echo "\">
...
\t\t\t\t\t\t\t";
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("LAST_POST");
                echo " ";
                echo $this->extensions['an602\template\twig\extension']->lang("POST_BY_AUTHOR");
                echo " ";
                ...
                echo "\" title=\"";
                echo $this->extensions['an602\template\twig\extension']->lang("GOTO_LAST_POST");
                echo "\"><time datetime=\"";
...
\t\t\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_POST_GLOBAL", [], "any", false, false, false, 191) && (($context["FORUM_ID"] ?? null) != twig_get_attribute($this->env, $this->source, $context["topicrow"], "FORUM_ID", [], "any", false, false, false, 191)))) {
                    echo "<br />";
                    echo $this->extensions['an602\template\twig\extension']->lang("POSTED");
                    echo " ";
                    echo $this->extensions['an602\template\twig\extension']->lang("IN");
                    echo " <a href=\"";
...
$context["pagination"], "S_IS_ELLIPSIS", [], "any", false, false, false, 214)) {
                        ...
                        echo $this->extensions['an602\template\twig\extension']->lang("ELLIPSIS");
                        echo "</span></li>
\t\t\t\t\t\t\t\t";
...
\t\t<strong>";
                // line 253
                echo $this->extensions['an602\template\twig\extension']->lang(((($context["S_SORT_DAYS"] ?? null)) ? ("NO_TOPICS_TIME_FRAME") : ("NO_TOPICS")));
                echo "</strong>
\t\t</div>
\t</div>
\t";
...
\t\t\t<strong>";
                // line 259
                echo $this->extensions['an602\template\twig\extension']->lang("NO_FORUMS_IN_CATEGORY");
                echo "</strong>
\t\t</div>
\t</div>
\t";
...
\t\t<h3><a href=\"";
            ...
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("WHO_IS_ONLINE");
            echo "</a></h3>
\t\t<p>";
            // line 306
...
\t\t<h3>";
            // line 312
            echo $this->extensions['an602\template\twig\extension']->lang("FORUM_PERMISSIONS");
            echo "</h3>
\t\t<p>";
            // line 313
            $context['_parent'] = $context;
