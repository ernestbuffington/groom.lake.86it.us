...
/* login_body.html */
class __TwigTemplate_f487c8d1adf8e6d56aa760d90c0603d6ecc1fbe0f060aeaa009adb57af41b863 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        ...
        if ((($context["S_DISPLAY_FULL_LOGIN"] ?? null) && (($context["U_SEND_PASSWORD"] ?? null) || ($context["U_RESEND_ACTIVATION"] ?? null)))) {
            ...
            if (($context["U_RESEND_ACTIVATION"] ?? null)) {
                ...
                echo "\">";
                echo $this->extensions['an602\template\twig\extension']->lang("RESEND_ACTIVATION");
                echo "</a></dd>";
            }
            // line 22
            echo "\t\t\t";
...
\t\t\t<p>";
            // line 58
            echo $this->extensions['an602\template\twig\extension']->lang("LOGIN_INFO");
            echo "</p>
\t\t\t<p><strong><a href=\"";
            // line 59
            echo ($context["U_TERMS_USE"] ?? null);
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("TERMS_USE");
            echo "</a> | <a href=\"";
            echo ($context["U_PRIVACY"] ?? null);
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("PRIVACY");
            echo "</a></strong></p>
\t\t\t<hr class=\"dashed\" />
\t\t\t<p><a href=\"";
            // line 61
