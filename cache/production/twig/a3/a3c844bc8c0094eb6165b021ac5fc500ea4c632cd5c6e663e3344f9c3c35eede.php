...
/* overall_header.html */
class __TwigTemplate_8a1322a00012aa8e4d550129bf4c155c6708513c43b513297ca111861c1903a7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<title>";
        ...
        if (($context["S_IN_MCP"] ?? null)) {
            echo $this->extensions['an602\template\twig\extension']->lang("MCP");
            echo " - ";
        } elseif (($context["S_IN_UCP"] ?? null)) {
            echo $this->extensions['an602\template\twig\extension']->lang("UCP");
            echo " - ";
        }
...
";
        ...
        if (($context["S_ENABLE_FEEDS"] ?? null)) {
            ...
            if (($context["S_ENABLE_FEEDS_OVERALL"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo ($context["SITENAME"] ?? null);
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_index");
                echo "\">";
            }
            // line 12
            echo "\t";
            if (($context["S_ENABLE_FEEDS_NEWS"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo $this->extensions['an602\template\twig\extension']->lang("FEED_NEWS");
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_news");
                echo "\">";
            }
            // line 13
            echo "\t";
            if (($context["S_ENABLE_FEEDS_FORUMS"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo $this->extensions['an602\template\twig\extension']->lang("ALL_FORUMS");
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_forums");
                echo "\">";
            }
            // line 14
            echo "\t";
            if (($context["S_ENABLE_FEEDS_TOPICS"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo $this->extensions['an602\template\twig\extension']->lang("FEED_TOPICS_NEW");
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_topics");
                echo "\">";
            }
            // line 15
            echo "\t";
            if (($context["S_ENABLE_FEEDS_TOPICS_ACTIVE"] ?? null)) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo $this->extensions['an602\template\twig\extension']->lang("FEED_TOPICS_ACTIVE");
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_topics_active");
                echo "\">";
            }
            // line 16
            echo "\t";
            if ((($context["S_ENABLE_FEEDS_FORUM"] ?? null) && ($context["S_FORUM_ID"] ?? null))) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo $this->extensions['an602\template\twig\extension']->lang("FORUM");
                echo " - ";
                echo ($context["FORUM_NAME"] ?? null);
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_forum", ["forum_id" => ($context["S_FORUM_ID"] ?? null)]);
                echo "\">";
            }
            // line 17
            echo "\t";
            if ((($context["S_ENABLE_FEEDS_TOPIC"] ?? null) && ($context["S_TOPIC_ID"] ?? null))) {
                ...
                echo $this->extensions['an602\template\twig\extension']->lang("FEED");
                echo " - ";
                echo $this->extensions['an602\template\twig\extension']->lang("TOPIC");
                echo " - ";
                echo ($context["TOPIC_TITLE"] ?? null);
                echo "\" href=\"";
                echo $this->extensions['an602\template\twig\extension\routing']->getPath("an602_feed_topic", ["topic_id" => ($context["S_TOPIC_ID"] ?? null)]);
                echo "\">";
            }
            // line 18
            echo "\t";
...
";
        ...
        echo "
<!--
\tAN602 style name: prosilver
\tBased on style:   prosilver (this is the default AN6023 style)
...
<body id=\"an602\" class=\"nojs notouch section-";
        // line 75
...
\t\t\t\t<p class=\"skiplink\"><a href=\"#start_here\">";
        // line 92
        echo $this->extensions['an602\template\twig\extension']->lang("SKIP");
        echo "</a></p>
\t\t\t</div>
...
\t\t\t\t\t<input name=\"keywords\" id=\"keywords\" type=\"search\" maxlength=\"128\" title=\"";
            ...
            echo "\" placeholder=\"";
            echo $this->extensions['an602\template\twig\extension']->lang("SEARCH_MINI");
            echo "\" />
...
\t\t\t\t<strong>";
            // line 128
            echo $this->extensions['an602\template\twig\extension']->lang("INFORMATION");
            echo $this->extensions['an602\template\twig\extension']->lang("COLON");
            echo "</strong> ";
            echo $this->extensions['an602\template\twig\extension']->lang("BOARD_DISABLED");
            echo "
\t\t\t</div>
\t\t</div>
\t\t";
