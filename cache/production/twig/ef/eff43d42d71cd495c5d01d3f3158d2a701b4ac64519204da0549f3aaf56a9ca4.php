...
/* acp_bbcodes.html */
class __TwigTemplate_aedf1cc9e2ba1e8f53e125d83dc2b16fad92b01a0960fdeb94e0ee11879c43eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<h1>";
            // line 9
            echo $this->extensions['an602\template\twig\extension']->lang("ACP_BBCODES");
            echo "</h1>

\t<p>";
            // line 11
            echo $this->extensions['an602\template\twig\extension']->lang("ACP_BBCODES_EXPLAIN");
            echo "</p>
...
\t\t<legend>";
            // line 16
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_USAGE");
            echo "</legend>
\t\t<p>";
            // line 17
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_USAGE_EXPLAIN");
            echo "</p>
\t<dl>
\t\t<dt><label for=\"bbcode_match\">";
            // line 19
            echo $this->extensions['an602\template\twig\extension']->lang("EXAMPLES");
            echo "</label><br /><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_USAGE_EXAMPLE");
            echo "</span></dt>
...
\t\t<legend>";
            // line 25
            echo $this->extensions['an602\template\twig\extension']->lang("HTML_REPLACEMENT");
            echo "</legend>
\t\t<p>";
            // line 26
            echo $this->extensions['an602\template\twig\extension']->lang("HTML_REPLACEMENT_EXPLAIN");
            echo "</p>
\t<dl>
\t\t<dt><label for=\"bbcode_tpl\">";
            ...
            echo $this->extensions['an602\template\twig\extension']->lang("EXAMPLES");
            echo "</label><br /><br /><span>";
            echo $this->extensions['an602\template\twig\extension']->lang("HTML_REPLACEMENT_EXAMPLE");
            echo "</span></dt>
...
\t\t<legend>";
            // line 34
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_HELPLINE");
            echo "</legend>
\t\t<p>";
            // line 35
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_HELPLINE_EXPLAIN");
            echo "</p>
\t<dl>
\t\t<dt><label for=\"bbcode_helpline\">";
            // line 37
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_HELPLINE_TEXT");
            echo "</label></dt>
...
\t\t<legend>";
            // line 43
            echo $this->extensions['an602\template\twig\extension']->lang("SETTINGS");
            echo "</legend>
\t<dl>
\t\t<dt><label for=\"display_on_posting\">";
            // line 45
            echo $this->extensions['an602\template\twig\extension']->lang("DISPLAY_ON_POSTING");
            echo "</label></dt>
...
\t\t<th colspan=\"2\">";
            // line 64
            echo $this->extensions['an602\template\twig\extension']->lang("TOKENS");
            echo "</th>
\t</tr>
\t<tr>
\t\t<td class=\"row3\" colspan=\"2\">";
            // line 67
            echo $this->extensions['an602\template\twig\extension']->lang("TOKENS_EXPLAIN");
            echo "</td>
\t</tr>
\t<tr>
\t\t<th>";
            // line 70
            echo $this->extensions['an602\template\twig\extension']->lang("TOKEN");
            echo "</th>
\t\t<th>";
            // line 71
            echo $this->extensions['an602\template\twig\extension']->lang("TOKEN_DEFINITION");
            echo "</th>
\t</tr>
\t</thead>
\t<tbody>
...
\t\t<th>";
            // line 98
            echo $this->extensions['an602\template\twig\extension']->lang("BBCODE_TAG");
            echo "</th>
\t\t<th>";
            // line 99
...
\t\t\t<td colspan=\"2\">";
                // line 110
                echo $this->extensions['an602\template\twig\extension']->lang("ACP_NO_ITEMS");
                echo "</td>
\t\t</tr>
\t";
            }
...
\t\t<input class=\"button2\" name=\"submit\" type=\"submit\" value=\"";
            // line 117
            echo $this->extensions['an602\template\twig\extension']->lang("ADD_BBCODE");
            echo "\" />
\t</p>
\t";
            // line 119
