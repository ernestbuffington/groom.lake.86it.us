...
/* acp_update.html */
class __TwigTemplate_7fd0beb6e05422c4b9777084a2e929685cea8e9a00f462a897593879370172ba extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<h1>";
        // line 5
        echo $this->extensions['an602\template\twig\extension']->lang("VERSION_CHECK");
        echo "</h1>

<p>";
        // line 7
        echo $this->extensions['an602\template\twig\extension']->lang("VERSION_CHECK_EXPLAIN");
        echo "</p>
...
\t\t<p>";
            ...
            echo " ";
            echo $this->extensions['an602\template\twig\extension']->lang("UPDATE_INCOMPLETE_MORE");
            echo "</p>
\t</div>
";
        }
...
\t\t<p>";
            // line 16
            echo $this->extensions['an602\template\twig\extension']->lang("VERSION_UP_TO_DATE_ACP");
            echo " - <a href=\"";
...
\t\t<p>";
            // line 20
            echo $this->extensions['an602\template\twig\extension']->lang("VERSION_NOT_UP_TO_DATE_ACP");
            echo " - <a href=\"";
            echo ($context["U_VERSIONCHECK_FORCE"] ?? null);
            echo "\">";
            echo $this->extensions['an602\template\twig\extension']->lang("VERSIONCHECK_FORCE_UPDATE");
...
\t\t<dt><label>";
            // line 33
            echo $this->extensions['an602\template\twig\extension']->lang("CURRENT_VERSION");
            echo "</label></dt>
\t\t<dd><strong>";
            // line 34
...
\t\t<dt><label>";
            // line 38
            echo $this->extensions['an602\template\twig\extension']->lang("FILES_VERSION");
            echo "</label></dt>
\t\t<dd><strong>";
            // line 39
...
\t\t<dt><label>";
            // line 42
            echo $this->extensions['an602\template\twig\extension']->lang("DATABASE_VERSION");
            echo "</label></dt>
\t\t<dd><strong>";
            // line 43
            echo ($context["CURRENT_VERSION"] ?? null);
...
\t\t\t<dt><label>";
            // line 52
            echo $this->extensions['an602\template\twig\extension']->lang("LATEST_VERSION");
            echo "</label></dt>
\t\t\t<dd><strong>";
            // line 53
...
\t\t\t<dt><label>";
            // line 56
            echo $this->extensions['an602\template\twig\extension']->lang("RELEASE_ANNOUNCEMENT");
            echo "</label></dt>
\t\t\t<dd><strong><a href=\"";
            // line 57
