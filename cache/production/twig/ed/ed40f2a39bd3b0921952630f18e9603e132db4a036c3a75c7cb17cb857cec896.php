...
class __TwigTemplate_d0f821733430f126ab35a90f62334d86300697536edd6f4153cd616739997dfe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t<p>";
        // line 10
        echo $this->extensions['an602\template\twig\extension']->lang("GROUPS_EXPLAIN");
        echo "</p>
\t";
        // line 11
        $value = 0;
...
\t\t\t\t\t\t";
                ...
                if (($context["S_CHANGE_DEFAULT"] ?? null)) {
                    echo "<input title=\"";
                    echo $this->extensions['an602\template\twig\extension']->lang("CHANGE_DEFAULT_GROUP");
...
\t\t\t\t\t<dt><div class=\"list-inner\">";
            // line 48
            echo $this->extensions['an602\template\twig\extension']->lang("GROUP_MEMBER");
            echo "</div></dt>
\t\t\t\t\t<dd class=\"mark\">";
            // line 49
            echo $this->extensions['an602\template\twig\extension']->lang("SELECT");
...
\t\t\t\t\t<dt><div class=\"list-inner\">";
            // line 84
            echo $this->extensions['an602\template\twig\extension']->lang("GROUP_PENDING");
            echo "</div></dt>
\t\t\t\t\t<dd class=\"mark\">";
            // line 85
            echo $this->extensions['an602\template\twig\extension']->lang("SELECT");
...
\t\t\t\t\t<dt><div class=\"list-inner\">";
            // line 118
            echo $this->extensions['an602\template\twig\extension']->lang("GROUP_NONMEMBER");
            echo "</div></dt>
\t\t\t\t\t<dd class=\"mark\">";
            // line 119
            echo $this->extensions['an602\template\twig\extension']->lang("SELECT");
...
\t\t\t\t<option value=\"join\">";
                // line 161
                echo $this->extensions['an602\template\twig\extension']->lang("JOIN_SELECTED");
                echo "</option>
\t\t\t\t<option value=\"resign\">";
                // line 162
                echo $this->extensions['an602\template\twig\extension']->lang("RESIGN_SELECTED");
                echo "</option>
\t\t\t\t<option value=\"demote\">";
                // line 163
                echo $this->extensions['an602\template\twig\extension']->lang("DEMOTE_SELECTED");
                echo "</option>
\t\t\t</select>&nbsp;
