...
// eXtreme Styles mod cache. Generated on Mon, 29 Aug 2022 14:41:09 +0000 (time=1661784069)
...
$titanium_user_extra_count = ( isset($this->_tpldata['user_extra.']) ) ?  sizeof($this->_tpldata['user_extra.']) : 0;
for ($titanium_user_extra_i = 0; $titanium_user_extra_i < $titanium_user_extra_count; $titanium_user_extra_i++)
{
 $titanium_user_extra_item = &$this->_tpldata['user_extra.'][$titanium_user_extra_i];
 $titanium_user_extra_item['S_ROW_COUNT'] = $titanium_user_extra_i;
 $titanium_user_extra_item['S_NUM_ROWS'] = $titanium_user_extra_count;
...
if(isset($titanium_user_extra_item)) { unset($titanium_user_extra_item); } 
