...
// eXtreme Styles mod cache. Generated on Fri, 02 Sep 2022 08:17:27 +0000 (time=1662106647)
...
$phpbb2_birthdays_greeting_count = ( isset($this->_tpldata['birthdays_greeting.']) ) ?  sizeof($this->_tpldata['birthdays_greeting.']) : 0;
for ($phpbb2_birthdays_greeting_i = 0; $phpbb2_birthdays_greeting_i < $phpbb2_birthdays_greeting_count; $phpbb2_birthdays_greeting_i++)
{
 $phpbb2_birthdays_greeting_item = &$this->_tpldata['birthdays_greeting.'][$phpbb2_birthdays_greeting_i];
 $phpbb2_birthdays_greeting_item['S_ROW_COUNT'] = $phpbb2_birthdays_greeting_i;
 $phpbb2_birthdays_greeting_item['S_NUM_ROWS'] = $phpbb2_birthdays_greeting_count;
...
$phpbb2_birthdays_email_count = ( isset($phpbb2_birthdays_greeting_item['birthdays_email.']) ) ? sizeof($phpbb2_birthdays_greeting_item['birthdays_email.']) : 0;
for ($phpbb2_birthdays_email_i = 0; $phpbb2_birthdays_email_i < $phpbb2_birthdays_email_count; $phpbb2_birthdays_email_i++)
{
 $phpbb2_birthdays_email_item = &$phpbb2_birthdays_greeting_item['birthdays_email.'][$phpbb2_birthdays_email_i];
 $phpbb2_birthdays_email_item['S_ROW_COUNT'] = $phpbb2_birthdays_email_i;
 $phpbb2_birthdays_email_item['S_NUM_ROWS'] = $phpbb2_birthdays_email_count;
...
if(isset($phpbb2_birthdays_email_item)) { unset($phpbb2_birthdays_email_item); } 

?>

		  <?php

$phpbb2_birthdays_pm_count = ( isset($phpbb2_birthdays_greeting_item['birthdays_pm.']) ) ? sizeof($phpbb2_birthdays_greeting_item['birthdays_pm.']) : 0;
for ($phpbb2_birthdays_pm_i = 0; $phpbb2_birthdays_pm_i < $phpbb2_birthdays_pm_count; $phpbb2_birthdays_pm_i++)
{
 $phpbb2_birthdays_pm_item = &$phpbb2_birthdays_greeting_item['birthdays_pm.'][$phpbb2_birthdays_pm_i];
 $phpbb2_birthdays_pm_item['S_ROW_COUNT'] = $phpbb2_birthdays_pm_i;
 $phpbb2_birthdays_pm_item['S_NUM_ROWS'] = $phpbb2_birthdays_pm_count;
...
if(isset($phpbb2_birthdays_pm_item)) { unset($phpbb2_birthdays_pm_item); } 

?>

		  <?php

$phpbb2_birthdays_popup_count = ( isset($phpbb2_birthdays_greeting_item['birthdays_popup.']) ) ? sizeof($phpbb2_birthdays_greeting_item['birthdays_popup.']) : 0;
for ($phpbb2_birthdays_popup_i = 0; $phpbb2_birthdays_popup_i < $phpbb2_birthdays_popup_count; $phpbb2_birthdays_popup_i++)
{
 $phpbb2_birthdays_popup_item = &$phpbb2_birthdays_greeting_item['birthdays_popup.'][$phpbb2_birthdays_popup_i];
 $phpbb2_birthdays_popup_item['S_ROW_COUNT'] = $phpbb2_birthdays_popup_i;
 $phpbb2_birthdays_popup_item['S_NUM_ROWS'] = $phpbb2_birthdays_popup_count;
...
if(isset($phpbb2_birthdays_popup_item)) { unset($phpbb2_birthdays_popup_item); } 
...
if(isset($phpbb2_birthdays_greeting_item)) { unset($phpbb2_birthdays_greeting_item); } 
