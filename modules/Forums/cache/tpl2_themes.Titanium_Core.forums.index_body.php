...
// eXtreme Styles mod cache. Generated on Sun, 28 Aug 2022 22:40:18 +0000 (time=1661726418)
...
?><?php echo isset($phpbb2_colors_item['GROUPS']) ? $phpbb2_colors_item['GROUPS'] : ''; ?><?php
...
$phpbb2_birthdays_count = ( isset($this->_tpldata['birthdays.']) ) ?  sizeof($this->_tpldata['birthdays.']) : 0;
for ($phpbb2_birthdays_i = 0; $phpbb2_birthdays_i < $phpbb2_birthdays_count; $phpbb2_birthdays_i++)
{
 $phpbb2_birthdays_item = &$this->_tpldata['birthdays.'][$phpbb2_birthdays_i];
 $phpbb2_birthdays_item['S_ROW_COUNT'] = $phpbb2_birthdays_i;
 $phpbb2_birthdays_item['S_NUM_ROWS'] = $phpbb2_birthdays_count;
...
$phpbb2_upcoming_count = ( isset($phpbb2_birthdays_item['upcoming.']) ) ? sizeof($phpbb2_birthdays_item['upcoming.']) : 0;
for ($phpbb2_upcoming_i = 0; $phpbb2_upcoming_i < $phpbb2_upcoming_count; $phpbb2_upcoming_i++)
{
 $phpbb2_upcoming_item = &$phpbb2_birthdays_item['upcoming.'][$phpbb2_upcoming_i];
 $phpbb2_upcoming_item['S_ROW_COUNT'] = $phpbb2_upcoming_i;
 $phpbb2_upcoming_item['S_NUM_ROWS'] = $phpbb2_upcoming_count;

?><br /><?php echo isset($this->vars['UPCOMING']) ? $this->vars['UPCOMING'] : $this->lang('UPCOMING'); ?><?php

} // END upcoming

if(isset($phpbb2_upcoming_item)) { unset($phpbb2_upcoming_item); } 
...
if(isset($phpbb2_birthdays_item)) { unset($phpbb2_birthdays_item); } 
