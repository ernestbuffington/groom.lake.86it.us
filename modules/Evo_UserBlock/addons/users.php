...
function evouserinfo_users() 
{
	...
	aria-hidden="true"></i></font>&nbsp;'.$titanium_lang_evo_userblock['BLOCK']['USERS']['NEW_TODAY'].'<span style="float:right">'.number_format($today).'&nbsp;&nbsp;</span>';
    $evouserinfo_users .= '</div>';

    $evouserinfo_users .= '<div style="padding-left: 10px;">';
    $evouserinfo_users .= '<font color="gold"><i class="fas fa-radiation-alt" 
	aria-hidden="true"></i></font>&nbsp;'.$titanium_lang_evo_userblock['BLOCK']['USERS']['NEW_YESTERDAY'].'<span style="float:right">'.number_format($yesterday).'&nbsp;&nbsp;</span>';
    $evouserinfo_users .= '</div>';

    $evouserinfo_users .= '<div style="padding-left: 10px;">';
    $evouserinfo_users .= '<font color="gold"><i class="fas fa-radiation-alt" a
	ria-hidden="true"></i></font>&nbsp;'.$titanium_lang_evo_userblock['BLOCK']['USERS']['WAITING'].'<span style="float:right">'.number_format($waiting).'&nbsp;&nbsp;</span>';
    $evouserinfo_users .= '</div>';

    $evouserinfo_users .= '<div style="padding-left: 10px;">';
    $evouserinfo_users .= '<font color="gold"><i class="fas fa-radiation-alt" a
	ria-hidden="true"></i></font>&nbsp;'.$titanium_lang_evo_userblock['BLOCK']['USERS']['HIDDEN'].'<span style="float:right">'.number_format($hidden).'&nbsp;&nbsp;</span>';
    $evouserinfo_users .= '</div>';

    $evouserinfo_users .= '<div style="padding-left: 10px;">';
    $evouserinfo_users .= '<font color="gold"><i class="fas fa-radiation-alt" 
	aria-hidden="true"></i></font>&nbsp;'.$titanium_lang_evo_userblock['BLOCK']['USERS']['TOTAL'].'<span style="float:right">'.number_format($total).'&nbsp;&nbsp;</span>';
    $evouserinfo_users .= '</div>';

    $evouserinfo_users .= '<div style="padding-left: 10px;">';
    $evouserinfo_users .= '<font color="gold"><i class="fas fa-radiation-alt" 
	aria-hidden="true"></i></font>&nbsp;'.$titanium_lang_evo_userblock['BLOCK']['USERS']['LATEST']
