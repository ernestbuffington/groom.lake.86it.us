...
namespace an602\filesystem;

/**
 * Interface for AN602's filesystem service
 */
interface filesystem_interface
{
	 ...
	 * @throws \an602\filesystem\exception\filesystem_exception	the filename which triggered the error can be
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception When the file cannot be copied
	 */
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception When the file cannot be written
	 */
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception On any directory creation failure
	 * 															The filename which triggered the error can be
	 * 															retrieved by filesystem_exception::get_filename()
	 */
	 ...
	 * 															retrieved by filesystem_exception::get_filename()
	 */
	public function an602_chmod($file, $perms = null, $recursive = false, $force_chmod_link = false);
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception When removal fails.
	 * 															The filename which triggered the error can be
	 * 															retrieved by filesystem_exception::get_filename()
	 */
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception	When target file or directory already exists,
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception When symlink fails
	 */
	 ...
	 *
	 * @throws \an602\filesystem\exception\filesystem_exception	When touch fails
	 */
