...
*/
class base implements \an602\extension\extension_interface
{
	...
	* @param \an602\finder $extension_finder
	* @param \an602\db\migrator $migrator
	...
	*/
	public function __construct(ContainerInterface $container, \an602\finder $extension_finder, \an602\db\migrator $migrator, $extension_name, $extension_path)
	{
