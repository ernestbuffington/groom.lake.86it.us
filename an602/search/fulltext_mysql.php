...
*/
class fulltext_mysql extends \an602\search\base
{
	/**
	...
	/**
	 * Constructor
	 * Creates a new \an602\search\fulltext_mysql, which is used as a search backend
	 *
	...
	*/
	public function init()
	{
		...
		$fulltext_supported = $engine === 'Aria' || $engine === 'MyISAM'
			 ...
			 */
			|| $engine === 'InnoDB'
			&& an602_version_compare($this->db->sql_server_info(true), '5.6.8', '>=');
	...
	*/
	public function keyword_search($type, $fields, $terms, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_by_keyword_modify_search_key', compact($vars)));
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_keywords_main_query_before', compact($vars)));
	...
	*/
	public function author_search($type, $firstpost_only, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_by_author_modify_search_key', compact($vars)));
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_author_query_before', compact($vars)));
	...
	*/
	public function index($mode, $post_id, &$message, &$subject, $poster_id, $forum_id)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_index_before', compact($vars)));
	...
	*/
	public function create_index($acp_module, $u_action)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_create_index_before', compact($vars)));
	...
	*/
	public function delete_index($acp_module, $u_action)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_mysql_delete_index_before', compact($vars)));
