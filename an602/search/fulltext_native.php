...
/**
* AN602's own db driven fulltext search, version 2
*/
class fulltext_native extends \an602\search\base
{
	...
	*/
	public function keyword_search($type, $fields, $terms, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_native_by_keyword_modify_search_key', compact($vars)));
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_native_keywords_count_query_before', compact($vars)));
	...
	*/
	public function author_search($type, $firstpost_only, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_native_by_author_modify_search_key', compact($vars)));
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_native_author_count_query_before', compact($vars)));
	...
	*/
	public function index($mode, $post_id, &$message, &$subject, $poster_id, $forum_id)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_native_index_before', compact($vars)));
	...
	*/
	public function delete_index($acp_module, $u_action)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_native_delete_index_before', compact($vars)));
