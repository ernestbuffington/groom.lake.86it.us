...
*/
class fulltext_postgres extends \an602\search\base
{
	/**
	...
	*/
	public function keyword_search($type, $fields, $terms, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_postgres_by_keyword_modify_search_key', compact($vars)));
	...
	*/
	public function author_search($type, $firstpost_only, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_postgres_by_author_modify_search_key', compact($vars)));
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_postgres_author_count_query_before', compact($vars)));
	...
	*/
	public function index($mode, $post_id, &$message, &$subject, $poster_id, $forum_id)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_postgres_index_before', compact($vars)));
	...
	*/
	public function create_index($acp_module, $u_action)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_postgres_create_index_before', compact($vars)));
	...
	*/
	public function delete_index($acp_module, $u_action)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.search_postgres_delete_index_before', compact($vars)));
