...
class manager
{
	 ...
	 * @param \an602\config\db_text				$config_text			Config_text object
	 * @param \an602\db\driver\driver_interface	$db						Database object
	 * @param \an602\db\tools\tools				$db_tools				Database tools object
	 * @param \an602\event\dispatcher_interface	$dispatcher				Event dispatcher object
	 ...
	 * @param \an602\di\service_collection		$type_collection		CPF Type collection
	...
	public function __construct(
		\an602\auth\auth $auth,
		\an602\config\db_text $config_text,
		\an602\db\driver\driver_interface $db,
		\an602\db\tools\tools $db_tools,
		\an602\event\dispatcher_interface $dispatcher,
		\an602\language\language $language,
		\an602\log\log $log,
		\an602\request\request $request,
		\an602\template\template $template,
		\an602\di\service_collection $type_collection,
		\an602\user $user,
		$fields_table,
		$fields_data_table,
	...
	public function generate_profile_fields($mode, $lang_id)
	{
		...
		{
			/** @var \an602\profilefields\type\type_interface $profile_field */
