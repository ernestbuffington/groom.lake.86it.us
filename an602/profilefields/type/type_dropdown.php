...
namespace an602\profilefields\type;

class type_dropdown extends type_base
{
	/**
	* Profile fields language helper
	* @var \an602\profilefields\lang_helper
	*/
	...
	* Construct
	*
	* @param	\an602\profilefields\lang_helper		$lang_helper	Profile fields language helper
	...
	*/
	public function __construct(\an602\profilefields\lang_helper $lang_helper, \an602\request\request $request, \an602\template\template $template, \an602\user $user)
	{
