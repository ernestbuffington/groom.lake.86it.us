...
class filespec
{
	...
	/** @var \an602\plupload\plupload The plupload object */
	protected $plupload;

	/** @var \an602\mimetype\guesser AN602 Mimetype guesser */
	protected $mimetype_guesser;

	/**
	 * File upload class
	 *
	 * @param \an602\filesystem\filesystem_interface	$an602_filesystem Filesystem
	 ...
	 * @param \an602\mimetype\guesser	$mimetype_guesser Mime type guesser
	 * @param \an602\plupload\plupload	$plupload Plupload
	 */
	public function __construct(\an602\filesystem\filesystem_interface $an602_filesystem, language $language, \bantu\IniGetWrapper\IniGetWrapper $php_ini, \FastImageSize\FastImageSize $imagesize, $an602_root_path, \an602\mimetype\guesser $mimetype_guesser = null, \an602\plupload\plupload $plupload = null)
	{
	 ...
	 *
	 * @return \an602\files\filespec This instance of the filespec class
	 */
	 ...
	 * The an602_root_path variable will be applied to the destination path
	 *
	 ...
	 *				The mode entered here reflects the mode defined by {@link an602_chmod()}
	 *
	...
	public function move_file($destination, $overwrite = false, $skip_image_check = false, $chmod = false)
	{
		...
		$chmod = ($chmod === false) ? \an602\filesystem\filesystem_interface::CHMOD_READ | \an602\filesystem\filesystem_interface::CHMOD_WRITE : $chmod;

		// We need to trust the admin in specifying valid upload directories and an attacker not being able to overwrite it...
		$this->destination_path = $this->an602_root_path . $destination;
		...
		else
		{
			...
			try
			{
				$this->filesystem->an602_chmod($this->destination_file, $chmod);
			}
