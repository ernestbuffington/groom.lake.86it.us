...
use an602\routing\resources_locator\resources_locator_interface;
...
class router implements RouterInterface
{
	...
	protected function create_dumped_url_matcher()
	{
		try
		{
			...
			$this->matcher = new \an602_url_matcher($this->context);
		}
		catch (IOException $e)
		{
	...
	protected function create_dumped_url_generator()
	{
		try
		{
			...
			$this->generator = new \an602_url_generator($this->context);
		}
		catch (IOException $e)
		{
