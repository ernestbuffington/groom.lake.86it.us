...
class avatar extends \Twig_Extension
{
	 ...
	 *
	 * @uses \an602_get_group_avatar()
	 * @uses \an602_get_user_avatar()
	 *
	...
	public function get_avatar()
	{
		...
		{
			case 'group':
				return $alt ? an602_get_group_avatar($row, $alt, $ignore_config, $lazy) : an602_get_group_avatar($row);
			break;

			case 'user':
				return $alt ? an602_get_user_avatar($row, $alt, $ignore_config, $lazy) : an602_get_user_avatar($row);
			break;
