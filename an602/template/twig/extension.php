...
class extension extends \Twig\Extension\AbstractExtension
{
	...
	* Constructor
	*
	* @param \an602\template\context $context
	* @param \an602\template\twig\environment $environment
	* @param \an602\language\language $language
	*/
	public function __construct(\an602\template\context $context, \an602\template\twig\environment $environment, $language)
	{
	...
	*/
	...
	{
		return array(
			new \an602\template\twig\tokenparser\defineparser,
			new \an602\template\twig\tokenparser\includeparser,
			new \an602\template\twig\tokenparser\includejs,
			new \an602\template\twig\tokenparser\includecss,
			new \an602\template\twig\tokenparser\event($this->environment),
			new \an602\template\twig\tokenparser\includephp($this->environment),
			new \an602\template\twig\tokenparser\php($this->environment),
		);
	}
