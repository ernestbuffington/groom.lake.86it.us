	...
	*/
	public function compile(\Twig\Compiler $compiler)
	{
		...
		$compiler
			...
			->raw(";\n")
			->write("\$asset = new \an602\\template\\asset(\$asset_file, \$this->env->get_path_helper(), \$this->env->get_filesystem());\n")
			->write("if (substr(\$asset_file, 0, 2) !== './' && \$asset->is_relative()) {\n")
			->indent()
				->write("\$asset_path = \$asset->get_path();")
				->write("\$local_file = \$this->env->get_an602_root_path() . \$asset_path;\n")
			...
			->indent()
			->write("\$asset->add_assets_version(\$this->env->get_an602_config()['assets_version']);\n")
			->outdent()
			->write("}\n")
