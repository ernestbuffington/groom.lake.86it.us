...
class event extends \Twig\Node\Node
{
	...
	*/
	...
	public function __construct(\Twig\Node\Expression\AbstractExpression $expr, \an602\template\twig\environment $environment, $lineno, $tag = null)
	{
	...
	*/
	public function compile(\Twig\Compiler $compiler)
	{
		...
		foreach ($this->environment->get_an602_extensions() as $ext_namespace => $ext_path)
		{
