...
use an602\feed\exception\no_feed_exception;
use an602\feed\exception\no_topic_exception;
use an602\feed\exception\unauthorized_forum_exception;
use an602\feed\exception\unauthorized_topic_exception;
...
class topic extends post_base
{
	...
	public function open()
	{
		...
		if (an602_optionget(FORUM_OPTION_FEED_EXCLUDE, $this->topic_data['forum_options']))
		{
