...
class php_exporter
{
	...
	* @param mixed $extension	String 'vendor/ext' to filter, null for AN602 core
	* @param string $min_version
	* @param string $max_version
	*/
	public function __construct($an602_root_path, $extension = null, $min_version = null, $max_version = null)
	{
		$this->root_path = $an602_root_path;
		$this->path = $an602_root_path;
	...
	*/
	...
	/**
	* Crawl the AN602/ directory for php events
	* @return int	The number of events found
	*/
	public function crawl_an602_directory_php()
	{
	...
	public function get_recursive_file_list()
	{
		try
		{
			$iterator = new \RecursiveIteratorIterator(
				new \an602\event\recursive_event_filter_iterator(
	...
	*/
	...
	{
		return (!$this->min_version || an602_version_compare($this->min_version, $version, '<='))
			&& (!$this->max_version || an602_version_compare($this->max_version, $version, '>='));
	}
