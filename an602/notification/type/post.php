...
class post extends \an602\notification\type\base
{
	...
	*/
	...
	public function set_config(\an602\config\config $config)
	{
		$this->config = $config;
	}

	public function set_user_loader(\an602\user_loader $user_loader)
	{
	...
	*/
	public function get_title()
	{
		...
		return $this->language->lang(
			$this->language_key,
			an602_generate_string_list($usernames, $this->user),
			$responders_cnt
		);
	}
	...
	*/
	...
	{
		return append_sid($this->an602_root_path . 'viewtopic.' . $this->php_ext, "p={$this->item_id}#p{$this->item_id}");
	}
	...
	*/
	...
	{
		return append_sid($this->an602_root_path . 'viewtopic.' . $this->php_ext, "t={$this->item_parent_id}&amp;view=unread#unread");
	}
