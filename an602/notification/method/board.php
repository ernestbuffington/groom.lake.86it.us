...
class board extends \an602\notification\method\base
{
	...
	*/
	public function __construct(\an602\user_loader $user_loader, \an602\db\driver\driver_interface $db, \an602\cache\driver\driver_interface $cache, \an602\user $user, \an602\config\config $config, $notification_types_table, $notifications_table)
	{
	...
	* {@inheritdoc}
	*/
	public function add_to_queue(\an602\notification\type\type_interface $notification)
	{
	...
	*/
	...
	{
		$insert_buffer = new \an602\db\sql_insert_buffer($this->db, $this->notifications_table);
