...
class manager
{
	...
	* @param ContainerInterface $an602_container
	...
	* @return \an602\notification\manager
	*/
	public function __construct($notification_types, $notification_methods, ContainerInterface $an602_container, \an602\user_loader $user_loader, \an602\event\dispatcher_interface $an602_dispatcher, \an602\db\driver\driver_interface $db, \an602\cache\service $cache, \an602\language\language $language, \an602\user $user, $notification_types_table, $user_notifications_table)
	{
	...
	*/
	public function add_notifications($notification_type_name, $data, array $options = array())
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.notification_manager_add_notifications_before', compact($vars)));
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.notification_manager_add_notifications', compact($vars)));
	...
	*/
	public function add_notifications_for_users($notification_type_name, $data, $notify_users)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.notification_manager_add_notifications_for_users_modify_data', compact($vars)));
	...
	*/
	...
	{
		$object = $this->an602_container->get($object_name);
