...
*/
class gravatar extends \an602\avatar\driver\driver
{
	/**
	...
	*        \an602\avatar\manager::clean_row
	...
	*/
	protected function get_gravatar_url($row)
	{
		...
		*/
		$vars = array('row', 'url');
		extract($an602_dispatcher->trigger_event('core.get_gravatar_url_after', compact($vars)));
