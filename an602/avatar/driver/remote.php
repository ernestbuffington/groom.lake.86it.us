...
*/
class remote extends \an602\avatar\driver\driver
{
	/**
	* {@inheritdoc}
	*/
	...
	*/
	public function process_form($request, $template, $user, $row, &$error)
	{
		...
		extract($an602_dispatcher->trigger_event('core.ucp_profile_avatar_upload_validation', compact($vars)));
		...
		$types = \an602\files\upload::image_types();
		$extension = strtolower(\an602\files\filespec::get_extension($url));
