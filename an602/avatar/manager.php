...
class manager
{
	...
	* @param \an602\event\dispatcher_interface $an602_dispatcher AN602 event dispatcher
	* @param array $avatar_drivers Avatar drivers passed via the service container
	*/
	public function __construct(\an602\config\config $config, \an602\event\dispatcher_interface $an602_dispatcher, $avatar_drivers)
	{
		$this->config = $config;
	...
	*
	* @param \an602\user AN602 User object
	...
	*/
	public function localize_errors(\an602\user $user, $error)
	{
	...
	*
	* @param \an602\db\driver\driver_interface $db AN602 dbal
	* @param \an602\user    $user AN602 user object
	...
	* @return null
	*/
	public function handle_avatar_delete(\an602\db\driver\driver_interface $db, \an602\user $user, $avatar_data, $table, $prefix)
	{
		...
		* @var	\an602\user	user		AN602 user object
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.avatar_manager_avatar_delete_after', compact($vars)));
	}
