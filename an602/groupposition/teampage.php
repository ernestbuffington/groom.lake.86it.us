...
*/
class teampage implements \an602\groupposition\groupposition_interface
{
	/**
	...
	*/
	public function __construct(\an602\db\driver\driver_interface $db, \an602\user $user, \an602\cache\driver\driver_interface $cache)
	{
		$this->db = $db;
		$this->user = $user;
		$this->cache = $cache;
	...
	* @throws \an602\groupposition\exception
	*/
	public function get_group_value($group_id)
	{
		...
		{
			// Group not found.
			throw new \an602\groupposition\exception('NO_GROUP');
		}
