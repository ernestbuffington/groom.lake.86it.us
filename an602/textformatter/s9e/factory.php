...
*/
class factory implements \an602\textformatter\cache_interface
{
	/**
	* @var \an602\textformatter\s9e\link_helper
	*/
	...
	*/
	...
	/**
	* @var \an602\textformatter\data_access
	*/
	...
	* Constructor
	*
	* @param \an602\textformatter\data_access $data_access
	...
	* @param \an602\textformatter\s9e\link_helper $link_helper
	* @param \an602\log\log_interface $log
	* @param string $cache_dir          Path to the cache dir
	* @param string $cache_key_parser   Cache key used for the parser
	* @param string $cache_key_renderer Cache key used for the renderer
	*/
	public function __construct(\an602\textformatter\data_access $data_access, \an602\cache\driver\driver_interface $cache, \an602\event\dispatcher_interface $dispatcher, \an602\config\config $config, \an602\textformatter\s9e\link_helper $link_helper, \an602\log\log_interface $log, $cache_dir, $cache_key_parser, $cache_key_renderer)
	{
	...
	*/
	public function get_configurator()
	{
		...
		*/
		...
		// Create custom filters for BBCode tokens that are supported in AN602 but not in
		// s9e\TextFormatter
		...
		// Create a custom filter for AN602's per-mode font size limits
		$configurator->attributeFilters
	...
	*/
	protected function extract_templates($template)
	{
		...
		// Allow either AN602 template or the Twig syntax
