...
*/
class parser implements \an602\textformatter\parser_interface
{
	/**
	...
	*/
	public function __construct(\an602\cache\driver\driver_interface $cache, $key, factory $factory, \an602\event\dispatcher_interface $dispatcher)
	{
		...
		* @var \an602\textformatter\s9e\parser parser This parser service
		* @since 3.2.0-a1
		*/
		$vars = array('parser');
	...
	* {@inheritdoc}
	*
	* This will convert the log entries found in s9e\TextFormatter's logger into AN602 error
	* messages
	*/
