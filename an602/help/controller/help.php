...
class help
{
	 ...
	 */
	public function __construct(\an602\controller\helper $helper, \an602\event\dispatcher_interface $dispatcher, \an602\template\template $template, \an602\user $user, $root_path, $php_ext)
	{
		$this->helper = $helper;
