...
class manager
{
	 ...
	 */
	public function __construct(\an602\event\dispatcher_interface $dispatcher, \an602\language\language $language, \an602\template\template $template)
	{
