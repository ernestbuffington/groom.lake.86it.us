...
/**
* AN602 custom extensions to the PHP DateTime class
* This handles the relative formats AN602 employs
*/
class datetime extends \DateTime
{
	...
	*/
	...
	/**
	* @var array Date formats are preprocessed by AN602, to save constant recalculation they are cached.
	*/
	static protected $format_cache = array();

	/**
	* Constructs a new instance of \an602\datetime, expanded to include an argument to inject
