...
class factory
{
	...
	* @param \an602\di\service_collection                              $plugins
	*/
	public function __construct(\Symfony\Component\DependencyInjection\ContainerInterface $container, \an602\di\service_collection $plugins)
	{
