...
class qa
{
	...
	*/
	public function is_installed()
	{
		...
		$db_tool = $an602_container->get('dbal.tools');
	...
	*/
	...
	{
		global $an602_log, $template, $user;
		...
		{
			/** @var \an602\log\log_interface $an602_log */
			$an602_log->add('critical', $user->data['user_id'], $user->ip, 'LOG_ERROR_CAPTCHA', time(), array($user->lang('CONFIRM_QUESTION_MISSING')));
			return false;
		}
		else
		{
	...
	*/
	...
	{
		global $config, $request, $an602_log, $template, $user;
