...
class recaptcha_v3 extends captcha_abstract
{
	...
	public function acp_page($id, $module)
	{
		 ...
		 * @var \an602\config\config		$config		Config object
		 * @var \an602\language\language	$language	Language object
		 * @var \an602\log\log				$an602_log	Log object
		 ...
		 */
		global $config, $language, $an602_log, $request, $template, $user;
	...
	public function get_template()
	{
		 ...
		 */
		global $config, $language, $template, $an602_root_path, $phpEx;
		...
		$contact = an602_get_board_contact_link($config, $an602_root_path, $phpEx);
