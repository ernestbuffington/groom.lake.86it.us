...
class ajax_iohandler extends iohandler_base
{
	 ...
	 * @param \an602\request\request_interface	$request	HTTP request interface
	 * @param \an602\template\template			$template	Template engine
	 * @param router 							$router		Router
	 * @param string 							$root_path	Path to AN602's root
	 */
	public function __construct(path_helper $path_helper, \an602\request\request_interface $request, \an602\template\template $template, router $router, $root_path)
	{
