...
use an602\install\exception\invalid_dbms_exception;
...
class database
{
	...
	protected $supported_dbms = array(
		...
		'mssql_odbc'=>	array(
			...
			'MODULE'		=> 'odbc',
			'DELIM'			=> ';',
			'DRIVER'		=> 'an602\db\driver\mssql_odbc',
			'AVAILABLE'		=> true,
			'2.0.x'			=> true,
		),
		'mssqlnative'		=> array(
			...
			'MODULE'		=> 'sqlsrv',
			'DELIM'			=> ';',
			'DRIVER'		=> 'an602\db\driver\mssqlnative',
			'AVAILABLE'		=> true,
			'2.0.x'			=> false,
		),
		'oracle'	=>	array(
		...
		'postgres' => array(
			...
			'MODULE'		=> 'pgsql',
			'DELIM'			=> ';',
			'DRIVER'		=> 'an602\db\driver\postgres',
			'AVAILABLE'		=> true,
			'2.0.x'			=> true,
		),
		'sqlite3'		=> array(
			...
			'MODULE'		=> 'sqlite3',
			'DELIM'			=> ';',
			'DRIVER'		=> 'an602\db\driver\sqlite3',
			'AVAILABLE'		=> true,
			'2.0.x'			=> false,
		),
	);
	 ...
	 * Constructor
	 *
	 * @param \an602\filesystem\filesystem_interface	$filesystem			Filesystem interface
	 * @param string									$an602_root_path	Path to AN602's root
	 */
	public function __construct(\an602\filesystem\filesystem_interface $filesystem, $an602_root_path)
	{
	...
	/**
	 * Returns an array of available DBMS supported by AN602
	 *
	...
	public function check_database_connection($dbms, $dbhost, $dbport, $dbuser, $dbpass, $dbname, $an602_table_prefix)
	{
		...
		/** @var \an602\db\driver\driver_interface $db */
		...
		if ($dbms_info['SCHEMA'] === 'sqlite'
			&& stripos($this->filesystem->realpath($dbhost), $this->filesystem->realpath($this->an602_root_path) === 0))
		{
			$errors[] = array(
