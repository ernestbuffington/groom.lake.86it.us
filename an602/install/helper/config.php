...
class config
{
	 ...
	 * Constructor
	 */
	public function __construct(\an602\filesystem\filesystem_interface $filesystem, \bantu\IniGetWrapper\IniGetWrapper $php_ini, $an602_root_path)
	{
		...
		$this->install_config_file = $this->an602_root_path . 'store/install_config.php';
