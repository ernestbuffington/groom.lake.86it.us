...
/**
 * Controller for installing AN602
 */
class install
{
	/**
	 ...
	 *
	 * @throws http_exception When AN602 is already installed
	 */
	public function handle()
	{
		...
		$this->template->assign_vars(array(
			'U_ACTION' => $this->controller_helper->route('an602_installer_install'),
		));
		...
		else
		{
			...
			if (true)
			{
				...
				/** @var \an602\install\helper\iohandler\iohandler_interface $iohandler */
