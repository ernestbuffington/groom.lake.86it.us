...
namespace an602\install\console\command\install\config;

use an602\install\helper\iohandler\factory;
use an602\install\installer_configuration;
...
class validate extends \an602\console\command\command
{
	/**
	 * @var factory
	 */
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		/** @var \an602\install\helper\iohandler\cli_iohandler $iohandler */
