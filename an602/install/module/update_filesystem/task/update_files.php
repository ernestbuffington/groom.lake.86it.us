...
use an602\install\helper\file_updater\factory;
use an602\install\helper\file_updater\file_updater_interface;
...
class update_files extends task_base
{
	 ...
	 */
	public function __construct(container_factory $container, config $config, iohandler_interface $iohandler, factory $file_updater_factory, update_helper $update_helper, $an602_root_path)
	{
	...
	protected function get_file_updater($file_updater_method = null)
	{
		...
		if ($file_updater_method === 'compression')
		{
			...
			/** @var \an602\install\helper\file_updater\compression_file_updater $file_updater */
		...
		{
			/** @var \an602\install\helper\file_updater\ftp_file_updater $file_updater */
