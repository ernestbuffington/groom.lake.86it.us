...
class diff_files extends task_base
{
	 ...
	 */
	public function __construct(container_factory $container, config $config, iohandler_interface $iohandler, update_helper $update_helper, $an602_root_path, $php_ext)
	{
