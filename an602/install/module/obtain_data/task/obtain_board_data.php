 ...
 */
class obtain_board_data extends \an602\install\task_base implements \an602\install\task_interface
{
	/**
	 ...
	 * @param \an602\language\language_file_helper					$lang_helper	Language file helper
	 */
	public function __construct(\an602\install\helper\config $config,
								...
								\an602\language\language_file_helper $lang_helper)
	{
