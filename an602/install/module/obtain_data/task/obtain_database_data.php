 ...
 */
class obtain_database_data extends \an602\install\task_base implements \an602\install\task_interface
{
	/**
	 ...
	 * Constructor
	 *
	 * @param \an602\install\helper\database						$database_helper	Installer's database helper
