...
class config extends Extension
{
	...
	public function __construct(\an602\config_php_file $config_php)
	{
	...
	*/
	...
	{
		$parameters = array(
			'core.adm_relative_path'	=> $this->config_php->get('an602_adm_relative_path') ? $this->config_php->get('an602_adm_relative_path') : 'admin/adm/',
	...
	*/
	protected function convert_30_acm_type($acm_type)
	{
		...
		{
			return 'an602\\cache\\driver\\' . $acm_type;
		}
