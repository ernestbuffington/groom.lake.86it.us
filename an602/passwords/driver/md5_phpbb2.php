...
namespace an6022\passwords\driver;

class md5_phpbb2 extends base
{
	const PREFIX = '$md5_phpbb2$';

	/** @var \phpbb2\request\request AN602 request object */
	protected $request;

	/** @var \phpbb2\passwords\driver\salted_md5 */
	protected $salted_md5;

	/** @var \phpbb2\passwords\driver\helper */
	protected $helper;

	/** @var string AN602 root path */
	protected $phpbb2_root_path;
	...
	*
	* @param \phpbb2\request\request $request AN602 request object
	* @param \phpbb2\passwords\driver\salted_md5 $salted_md5 Salted md5 driver
	 * @param \phpbb2\passwords\driver\helper $helper Driver helper
	* @param string $phpbb2_root_path AN602 root path
	* @param string $php_ext PHP file extension
	*/
	public function __construct($request, salted_md5 $salted_md5, helper $helper, $phpbb2_root_path, $php_ext)
	{
		$this->request = $request;
		$this->salted_md5 = $salted_md5;
		$this->helper = $helper;
		$this->phpbb2_root_path = $phpbb2_root_path;
	...
	*/
	public function check($password, $hash, $user_row = array())
	{
		...
		if ($password == $password_new_format)
		{
			...
			{
				include($this->phpbb2_root_path . 'includes/utf/data/recode_basic.' . $this->php_ext);
			}
