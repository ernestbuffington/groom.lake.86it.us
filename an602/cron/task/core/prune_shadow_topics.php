...
*/
class prune_shadow_topics extends \an602\cron\task\base implements \an602\cron\task\parametrized
{
	...
	* @param \an602\log\log $log The AN602 log system
	* @param \an602\user $user The AN602 user object
	*/
	public function __construct($an602_root_path, $php_ext, \an602\config\config $config, \an602\db\driver\driver_interface $db, \an602\log\log $log, \an602\user $user)
	{
