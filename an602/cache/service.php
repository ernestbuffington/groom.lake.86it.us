...
class service
{
	...
	*/
	...
	/** @var \an602\event\dispatcher AN602 Event dispatcher */
	...
	*
	* @param \an602\cache\driver\driver_interface $driver The cache driver
	* @param \an602\config\config $config The config
	* @param \an602\db\driver\driver_interface $db Database connection
	* @param \an602\event\dispatcher $dispatcher Event dispatcher
	* @param string $an602_root_path Root path
	* @param string $php_ext PHP file extension
	*/
	public function __construct(\an602\cache\driver\driver_interface $driver, \an602\config\config $config, \an602\db\driver\driver_interface $db, \an602\event\dispatcher $dispatcher, $an602_root_path, $php_ext)
	{
	...
	*
	* @return \an602\cache\driver\driver_interface The cache driver
	*/
	...
	* @param \an602\cache\driver\driver_interface $driver The cache driver
	*/
	public function set_driver(\an602\cache\driver\driver_interface $driver)
	{
		$this->driver = $driver;
	}
