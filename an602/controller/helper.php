...
use an602\auth\auth;
use an602\cache\driver\driver_interface as cache_interface;
...
use an602\routing\helper as routing_helper;
...
class helper
{
	 ...
	 * @param request_interface $request AN602 request object
