...
class topic_form extends form
{
	...
	*/
	...
	{
		return sprintf($this->user->lang['RETURN_TOPIC'],  '<a href="' . append_sid($this->an602_root_path . 'viewtopic.' . $this->phpEx, 't=' . $this->topic_id) . '">', '</a>');
	}
	...
	*/
	public function render(\an602\template\template $template)
	{
		...
		$template->assign_vars(array(
			...
			'S_POST_ACTION'			=> append_sid($this->an602_root_path . 'memberlist.' . $this->phpEx, 'mode=email&amp;t=' . $this->topic_id))
		);
	}
}
