...
class run extends \an602\console\command\command
{
	...
	* @param \an602\cron\manager $cron_manager The cron manager containing
	*		the cron tasks to be executed.
	* @param \an602\lock\db $lock_db The lock for accessing database.
	*/
	public function __construct(\an602\user $user, \an602\cron\manager $cron_manager, \an602\lock\db $lock_db)
	{
