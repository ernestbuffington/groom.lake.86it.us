...
namespace an602\console\command\reparser;

use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;
use Symfony\Component\Console\Style\SymfonyStyle;

class list_all extends \an602\console\command\command
{
	/**
	...
	*/
	public function __construct(\an602\user $user, \an602\di\service_collection $reparsers)
	{
