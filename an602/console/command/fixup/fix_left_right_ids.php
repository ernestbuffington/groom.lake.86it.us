...
namespace an602\console\command\fixup;

use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;
use Symfony\Component\Console\Style\SymfonyStyle;

class fix_left_right_ids extends \an602\console\command\command
{
	/** @var \an602\user */
	protected $user;
	...
	*/
	public function __construct(\an602\user $user, \an602\db\driver\driver_interface $db, \an602\cache\driver\driver_interface $cache)
	{
		$this->user = $user;
		$this->db = $db;
		$this->cache = $cache;
	...
	* The code is mainly borrowed from Support toolkit for AN602 Olympus
	*
