...
* Usage:
* <code>
*	$buffer = new \an602\db\sql_insert_buffer($db, 'test_table', 1234);
*
*	while (do_stuff())
*	{
*		$buffer->insert(array(
...
class sql_insert_buffer
{
	...
	*/
	public function __construct(\an602\db\driver\driver_interface $db, $table_name, $max_buffered_rows = 500)
	{
		$this->db = $db;
