...
class schema_generator
{
	...
	* Constructor
	*/
	public function __construct(array $class_names, \an602\config\config $config, \an602\db\driver\driver_interface $db, \an602\db\tools\tools_interface $db_tools, $an602_root_path, $php_ext, $table_prefix)
	{
		$this->config = $config;
		$this->db = $db;
