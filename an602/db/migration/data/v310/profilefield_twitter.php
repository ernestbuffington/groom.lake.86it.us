...
class profilefield_twitter extends \an602\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'an602_twitter';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'an602_twitter',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'an602_twitter',
		'field_length'			=> '20',
		'field_minlen'			=> '1',
		'field_maxlen'			=> '15',
		'field_novalue'			=> '',
