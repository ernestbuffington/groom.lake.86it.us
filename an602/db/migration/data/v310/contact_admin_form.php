...
class contact_admin_form extends \an602\db\migration\migration
{
	...
	{
		return array('\an602\db\migration\data\v310\config_db_text');
	}
	...
	{
		$text_config = new \an602\config\db_text($this->db, $this->table_prefix . 'config_text');
