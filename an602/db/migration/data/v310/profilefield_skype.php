...
class profilefield_skype extends \an602\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'an602_skype';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'an602_skype',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'an602_skype',
		'field_length'			=> '20',
		'field_minlen'			=> '6',
		'field_maxlen'			=> '32',
		'field_novalue'			=> '',
