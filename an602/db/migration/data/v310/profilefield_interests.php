...
class profilefield_interests extends \an602\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'an602_interests';

	protected $profilefield_database_type = array('MTEXT', '');

	protected $profilefield_data = array(
		'field_name'			=> 'an602_interests',
		'field_type'			=> 'profilefields.type.text',
		'field_ident'			=> 'an602_interests',
		'field_length'			=> '3|30',
		'field_minlen'			=> '2',
		'field_maxlen'			=> '500',
		'field_novalue'			=> '',
