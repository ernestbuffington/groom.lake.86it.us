...
class auth_provider_oauth extends \an602\db\migration\migration
{
		...
		return array(
			'add_tables'	=> array(
				$this->table_prefix . 'oauth_tokens'	=> array(
					'COLUMNS' => array(
						'user_id'			=> array('UINT', 0), // an602_users.user_id
						'session_id'		=> array('CHAR:32', ''), // an602_sessions.session_id used only when user_id not set
