...
class profilefield_facebook extends \an602\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'an602_facebook';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'an602_facebook',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'an602_facebook',
		'field_length'			=> '20',
		'field_minlen'			=> '5',
		'field_maxlen'			=> '50',
		'field_novalue'			=> '',
