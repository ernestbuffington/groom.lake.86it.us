...
class release_3_0_9_rc1 extends \an602\db\migration\migration
{
	public function effectively_installed()
	{
		return an602_version_compare($this->config['version'], '3.0.9-RC1', '>=');
	}

	static public function depends_on()
	{
		return array('\an602\db\migration\data\v30x\release_3_0_8');
	}
			...
			'add_tables' => array(
				$this->table_prefix . 'login_attempts' => array(
					'COLUMNS' => array(
						...
						// soon as the \an602\db\tools\tools class is capable of properly
