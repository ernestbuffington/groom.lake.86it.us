...
class release_3_0_1_rc1 extends \an602\db\migration\migration
{
	public function effectively_installed()
	{
		return an602_version_compare($this->config['version'], '3.0.1-RC1', '>=');
	}
	...
	public function reset_smiley_size()
	{
		...
		{
			if (file_exists($this->an602_root_path . 'images/smilies/' . $smiley))
			{
