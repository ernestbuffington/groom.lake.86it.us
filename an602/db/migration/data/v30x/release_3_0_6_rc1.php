...
class release_3_0_6_rc1 extends \an602\db\migration\migration
{
	public function effectively_installed()
	{
		return an602_version_compare($this->config['version'], '3.0.6-RC1', '>=');
	}

	static public function depends_on()
	{
		return array('\an602\db\migration\data\v30x\release_3_0_5');
	}
	...
	{
		return array(
			array('config.add', array('captcha_plugin', 'an602_captcha_nogd')),
			array('if', array(
				($this->config['captcha_gd']),
				array('config.update', array('captcha_plugin', 'an602_captcha_gd')),
			)),
