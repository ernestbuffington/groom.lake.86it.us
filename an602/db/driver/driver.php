...
abstract class driver implements driver_interface
{
	...
	*/
	function __construct()
	{
		...
		$this->sql_layer = substr(get_class($this), strlen('an602\db\driver\\'));
	...
	*/
	...
	{
		global $cache, $starttime, $an602_root_path, $an602_path_helper;
			...
			case 'display':
				...
				echo '<!DOCTYPE html>
					...
					<head>
						...
						<link href="' . htmlspecialchars($an602_path_helper->update_web_root_path($an602_root_path) . $an602_path_helper->get_adm_relative_path(), ENT_COMPAT) . 'style/admin.css" rel="stylesheet" type="text/css" media="screen" />
					</head>
					<body id="errorpage">
					<div id="wrap">
						<div id="page-header">
						...
						<div id="page-footer">
							Powered by <a href="https://www.groom.lake.86it.us/">AN602</a>&reg; Forum Software &copy; AN602 Limited
						</div>
					</div>
					</body>
					</html>';
