...
use an602\captcha\factory;
use an602\captcha\plugins\captcha_abstract;
...
/**
 * Database authentication provider for AN6023
...
class db extends base
{
	...
	*/
	 ...
	 */
	public function __construct(factory $captcha_factory, config $config, driver_interface $db, manager $passwords_manager, request_interface $request, user $user, $an602_root_path, $php_ext)
	{
