...
interface provider_interface
{
	 ...
	 * provider.
	 *
	 * @param \an602\config\config	$new_config	Contains the new configuration values
	...
	* a forum account.
	*
	* @param	array	$login_link_data	Any data needed to link a AN602 account to
	*								an external account.
	...
	*/
	...
	/**
	* Links an external account to a AN602 account.
	*
	* @param	array	$link_data	Any data needed to link a AN602 account to
	*								an external account.
	*/
