...
/**
 * OAuth storage wrapper for AN602's cache
 */
class token_storage implements TokenStorageInterface
{
	 ...
	 */
	public function __construct(\an602\db\driver\driver_interface $db, \an602\user $user, $oauth_token_table, $oauth_state_table)
	{
		$this->db	= $db;
		$this->user	= $user;
