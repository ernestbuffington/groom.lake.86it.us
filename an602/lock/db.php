...
class db
{
	...
	* @param	\an602\config\config				$config			The AN602 configuration
	* @param	\an602\db\driver\driver_interface	$db				A database connection
	*/
	public function __construct($config_name, \an602\config\config $config, \an602\db\driver\driver_interface $db)
	{
