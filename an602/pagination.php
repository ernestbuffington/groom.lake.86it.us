...
class pagination
{
	...
	*/
	public function __construct(\an602\template\template $template, \an602\user $user, \an602\controller\helper $helper, \an602\event\dispatcher_interface $an602_dispatcher)
	{
	...
	*/
	protected function generate_page_link($base_url, $on_page, $start_name, $per_page)
	{
		...
		*/
		...
		extract($this->an602_dispatcher->trigger_event('core.pagination_generate_page_link', compact($vars)));
