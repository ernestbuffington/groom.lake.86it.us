...
function parseDocument($container) {
	...
	*/
	...
	$container.find(selector).each(function() {
		...
		if (!persistent) {
			an602.registerDropdown($menu.find('a.js-responsive-menu-link'), $menu.find('.dropdown'), false);
		}
	...
	*/
	$container.find('#tabs, #minitabs').not('[data-skip-responsive]').each(function() {
		...
		an602.registerDropdown($tabLink, $item.find('.dropdown'), {
...
jQuery(function($) {
	...
	// Swap .nojs and .hasjs
	$('#an602.nojs').toggleClass('nojs hasjs');
	$('#an602').toggleClass('hastouch', an602.isTouch);
	$('#an602.hastouch').removeClass('notouch');
