...
# MAIN MENU 
	...
	{  
		...
		{ 
			...
			if($titanium_moduleinthisgroup[$som_groupmenu][$keyinthisgroup] == "Horizonatal Rule") 
			{
			...
			else 
			{
		        ...
		        { 
					...
					if(($div==1) && ($keyinthisgroup<count($titanium_moduleinthisgroup[$som_groupmenu])-1 && $sublevelinthisgroup[$som_groupmenu][$keyinthisgroup]<$sublevelinthisgroup[$som_groupmenu][$keyinthisgroup+1])) 
					{
					...
					if($titanium_module[$z] != $main_module_titanium) 
					{
						if(($is_admin===1 AND $view[$z] == 2) OR $view[$z] != 2) 
						{
							...
							if($incategories==0) 
							{
								...
								$urldumodule99 = ($gt_url[$z]!="") ? $gt_url[$z] : "modules.php?name=".$titanium_module[$z] ; // GT-NextGen
