...
$lang = array_merge($lang, [
	...
	'AN602_SKELETON_EXT'				=> 'Skeleton Extension',
	'AN602_CREATE_SKELETON_EXT'			=> 'Create skeleton extension',
	'AN602_SKELETON_EXT_DOCS'			=> 'Read the Documentation',
	...
	'SKELETON_QUESTION_AN602_VERSION_MIN'			=> 'Please enter the minimum AN602 requirement of the extension',
	'SKELETON_QUESTION_AN602_VERSION_MIN_UI'		=> 'Minimum AN602 requirement of the extension',
	'SKELETON_QUESTION_AN602_VERSION_MIN_EXPLAIN'	=> 'default: &gt;=3.2.0',
	'SKELETON_QUESTION_AN602_VERSION_MAX'			=> 'Please enter the maximum AN602 requirement of the extension',
	'SKELETON_QUESTION_AN602_VERSION_MAX_UI'		=> 'Maximum AN602 requirement of the extension',
	'SKELETON_QUESTION_AN602_VERSION_MAX_EXPLAIN'	=> 'default: &lt;4.0.0@dev',
	...
	'SKELETON_QUESTION_COMPONENT_PHPLISTENER_EXPLAIN'	=> 'PHP event listeners work with core events to inject code into AN602.',
	...
	'SKELETON_QUESTION_COMPONENT_HTMLLISTENER_EXPLAIN'	=> 'Style listeners use template events to inject HTML, JS and CSS into AN602’s style files.',
	...
	'SKELETON_QUESTION_COMPONENT_NOTIFICATION_EXPLAIN'	=> 'Notifications allow an extension to notify users of specific activities. When choosing notifications, do not use AN602 3.1 as the minimum requirement. Notifications changed in AN602 3.2.0 and are not backwards compatible with 3.1.x.',
	...
	'SKELETON_QUESTION_COMPONENT_GITHUBACTIONS_EXPLAIN'	=> 'Github Actions allow you to run PHPUnit tests on your GitHub repository. This will generate the workflow YML needed to begin testing your AN602 extension with each commit and pull request. Note that this workflow will be inside a hidden folder (.github/workflows).',
	...
	'SKELETON_QUESTION_COMPONENT_TRAVIS_EXPLAIN'	=> 'Travis CI is a platform for running your PHPUnit tests on a GitHub repository. This will generate the basic config and script files needed to begin testing your AN602 extension with each commit and pull request.',
	...
	'SKELETON_INVALID_AN602_MIN_VERSION'=> 'The minimum AN602 version requirement is invalid.',
	'SKELETON_INVALID_AN602_MAX_VERSION'=> 'The maximum AN602 version requirement is invalid.',
	...
	'AN602_VERSION_ERROR'	=> 'AN602 3.2.3 or newer is required to use this extension.',
]);
