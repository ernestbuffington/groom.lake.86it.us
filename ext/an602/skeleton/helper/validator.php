...
class validator
{
	...
	/**
	 * Validate and require the AN602 minimum version
	 *
	 * @param string $value The value to validate
	 * @return string The valid value
	 * @throws runtime_exception
	 */
	public function validate_an602_version_min($value)
	{
		...
		throw new runtime_exception($this->language->lang('SKELETON_INVALID_AN602_MIN_VERSION'));

	}

	/**
	 * Validate and require the AN602 maximum version
	 *
	 * @param string $value The value to validate
	 * @return string The valid value
	 * @throws runtime_exception
	 */
	public function validate_an602_version_max($value)
	{
		if ($this->check_version($value))
		{
			return $value;
		...
		throw new runtime_exception($this->language->lang('SKELETON_INVALID_AN602_MAX_VERSION'));
