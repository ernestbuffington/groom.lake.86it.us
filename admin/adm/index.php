...
), $an602_admin_path . 'style');

$template->assign_var('T_ASSETS_PATH', $an602_root_path . 'assets');
$template->assign_var('T_TEMPLATE_PATH', $an602_admin_path . 'style');
...
$module->assign_tpl_vars(append_sid("{$an602_admin_path}index.$phpEx"));
