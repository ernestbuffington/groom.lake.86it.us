...
function merge_topics($forum_id, $topic_ids, $to_topic_id)
{
	...
	if (confirm_box(true))
	{
		...
		an602_update_rows_avoiding_duplicates_notify_status($db, TOPICS_WATCH_TABLE, 'topic_id', $topic_ids, $to_topic_id);

		// Update the bookmarks table.
		an602_update_rows_avoiding_duplicates($db, BOOKMARKS_TABLE, 'topic_id', $topic_ids, $to_topic_id);
