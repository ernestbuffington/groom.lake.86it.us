				...
				if ($submit)
				{
					...
					switch ($action)
					{
						...
						case 'delavatar':
							...
							$an602_avatar_manager->handle_avatar_delete($db, $user, $an602_avatar_manager->clean_row($user_row, 'user'), USERS_TABLE, 'user_');
			...
			case 'avatar':
				...
				if ($config['allow_avatar'])
				{
					...
					if ($request->is_set_post('avatar_delete'))
					{
						...
						{
							$an602_avatar_manager->handle_avatar_delete($db, $user, $avatar_data, USERS_TABLE, 'user_');
